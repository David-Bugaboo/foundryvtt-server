...
`;class g extends p{shadowOnly;angle=45;_distance=5;_resolution=PIXI.settings.FILTER_RESOLUTION;_tintFilter;_blurFilter;constructor(e={}){super();let t=e?{...g.defaults,...e}:g.defaults,{kernels:i,blur:a,quality:r,resolution:s}=t;this._tintFilter=new PIXI.Filter(h,f),this._tintFilter.uniforms.color=new Float32Array(4),this._tintFilter.uniforms.shift=new PIXI.Point,this._tintFilter.resolution=s,this._blurFilter=i?new PIXI.filters.KawaseBlurFilter(i):new PIXI.filters.KawaseBlurFilter(a,r),this._pixelSize=1,this.resolution=s;let{shadowOnly:o,rotation:l,distance:n,alpha:c,color:m}=t;this.shadowOnly=o,this.rotation=l,this.distance=n,this.alpha=c,this.color=m}apply(e,t,i,a){this._updateShiftAndScale();let r=e.getFilterTexture();this._tintFilter.apply(e,t,r,1),this._blurFilter.apply(e,r,i,a),!0!==this.shadowOnly&&e.applyFilter(this,t,i,0),e.returnFilterTexture(r)}_updateShiftAndScale(){let e=this.targetPlaceable?.worldTransform.a??1;this._tintFilter.uniforms.shift.set(this.distance*Math.cos(this.angle)*e,this.distance*Math.sin(this.angle)*e),this._pixelSize=Math.max(1,1*e)}get resolution(){return this._resolution}set resolution(e){this._resolution=e,this._tintFilter&&(this._tintFilter.resolution=e),this._blurFilter&&(this._blurFilter.resolution=e)}get distance(){return this._distance}set distance(e){this._distance=e}get rotation(){return this.angle/PIXI.DEG_TO_RAD}set rotation(e){this.angle=e*PIXI.DEG_TO_RAD}get alpha(){return this._tintFilter.uniforms.alpha}set alpha(e){this._tintFilter.uniforms.alpha=e}get color(){return PIXI.utils.rgb2hex(this._tintFilter.uniforms.color)}set color(e){new PIXI.Color(e).toRgbArray(this._tintFilter.uniforms.color)}get kernels(){return this._blurFilter.kernels}set kernels(e){this._blurFilter.kernels=e}get blur(){return this._blurFilter.blur}set blur(e){this._blurFilter.blur=e}get quality(){return this._blurFilter.quality}set quality(e){this._blurFilter.quality=e}get _pixelSize(){return this._blurFilter.pixelSize}set _pixelSize(e){this._blurFilter.pixelSize=e}}g.defaults={rotation:45,distance:5,color:0,alpha:.5,shadowOnly:!1,kernels:null,blur:2,quality:3,resolution:PIXI.settings.FILTER_RESOLUTION};class v extends PIXI.filters.TwistFilter{constructor(t){super(),this.enabled=!1,this.radiusPercent=50,this.angle=4,this.zOrder=240,this.animated={},this.offset=[0,0],this.autoFit=!1,this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams())}handleTransform(){this.offset[0]=this.placeableImg.worldTransform.tx,this.offset[1]=this.placeableImg.worldTransform.ty,this.radius=Math.max(this.placeableImg.width,this.placeableImg.height)*this.targetPlaceable.worldTransform.a*this.radiusPercent/200}}class b extends PIXI.filters.ZoomBlurFilter{constructor(t){super(),this.enabled=!1,this.strength=.1,this.radiusPercent=50,this.innerRadiusPercent=10,this.zOrder=300,this.animated={},this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams())}handleTransform(e){this.center[0]=.5*e.sourceFrame.width,this.center[1]=.5*e.sourceFrame.height,this.radius=Math.max(this.placeableImg.width,this.placeableImg.height)*this.targetPlaceable.worldTransform.a*this.radiusPercent/200,this.innerRadius=Math.max(this.placeableImg.width,this.placeableImg.height)*this.targetPlaceable.worldTransform.a*this.innerRadiusPercent/200}}class y extends p{blurXFilter;blurYFilter;_repeatEdgePixels;constructor(e=8,t=4,i=PIXI.settings.FILTER_RESOLUTION,a=5){super(),this.blurXFilter=new x(!0,e,t,i,a),this.blurYFilter=new x(!1,e,t,i,a),this.resolution=i,this.quality=t,this.blur=e,this.repeatEdgePixels=!1}apply(e,t,i,a){let r=Math.abs(this.blurXFilter.strength),s=Math.abs(this.blurYFilter.strength);if(r&&s){let r=e.getFilterTexture();this.blurXFilter.apply(e,t,r,PIXI.CLEAR_MODES.CLEAR),this.blurYFilter.apply(e,r,i,a),e.returnFilterTexture(r)}else s?this.blurYFilter.apply(e,t,i,a):this.blurXFilter.apply(e,t,i,a)}updatePadding(){this._repeatEdgePixels?this.padding=0:this.padding=2*Math.max(Math.abs(this.blurXFilter.strength),Math.abs(this.blurYFilter.strength))}get blur(){return this.blurXFilter.blur}set blur(e){this.blurXFilter.blur=this.blurYFilter.blur=e,this.updatePadding()}get quality(){return this.blurXFilter.quality}set quality(e){this.blurXFilter.quality=this.blurYFilter.quality=e}get blurX(){return this.blurXFilter.blur}set blurX(e){this.blurXFilter.blur=e,this.updatePadding()}get blurY(){return this.blurYFilter.blur}set blurY(e){this.blurYFilter.blur=e,this.updatePadding()}get blendMode(){return this.blurYFilter.blendMode}set blendMode(e){this.blurYFilter.blendMode=e}get repeatEdgePixels(){return this._repeatEdgePixels}set repeatEdgePixels(e){this._repeatEdgePixels=e,this.updatePadding()}}class x extends p{horizontal;strength;passes;_quality;constructor(e,t=8,i=4,a=PIXI.settings.FILTER_RESOLUTION,r=5){super(function(e,t){let i;let a=Math.ceil(e/2),r=C,s="";i=t?"vBlurTexCoords[%index%] =  textureCoord + vec2(%sampleIndex% * strength, 0.0);":"vBlurTexCoords[%index%] =  textureCoord + vec2(0.0, %sampleIndex% * strength);";for(let t=0;t<e;t++){let e=i.replace("%index%",t.toString());s+=(e=e.replace("%sampleIndex%",`${t-(a-1)}.0`))+"\n"}return(r=r.replace("%blur%",s)).replace("%size%",e.toString())}(r,e),function(e){let t;let i=T[e],a=i.length,r="varying vec2 vBlurTexCoords[%size%];\nuniform sampler2D uSampler;\nvoid main(void)\n{\n    gl_FragColor = vec4(0.0);\n    %blur%\n}",s="";for(let r=0;r<e;r++){let o="gl_FragColor += texture2D(uSampler, vBlurTexCoords[%index%]) * %value%;".replace("%index%",r.toString());t=r,r>=a&&(t=e-r-1),s+=(o=o.replace("%value%",i[t].toString()))+"\n"}return(r=r.replace("%blur%",s)).replace("%size%",e.toString())}(r)),this.horizontal=e,this.resolution=a,this._quality=0,this.quality=i,this.blur=t}apply(e,t,i,a){if(i?this.horizontal?this.uniforms.strength=1/i.width*(i.width/t.width):this.uniforms.strength=1/i.height*(i.height/t.height):this.horizontal?this.uniforms.strength=1/e.renderer.width*(e.renderer.width/t.width):this.uniforms.strength=1/e.renderer.height*(e.renderer.height/t.height),this.uniforms.strength*=this.strength,this.uniforms.strength/=this.passes,1===this.passes)e.applyFilter(this,t,i,a);else{let r=e.getFilterTexture(),s=e.renderer,o=t,l=r;this.state.blend=!1,e.applyFilter(this,o,l,PIXI.CLEAR_MODES.CLEAR);for(let t=1;t<this.passes-1;t++){e.bindAndClear(o,PIXI.CLEAR_MODES.BLIT),this.uniforms.uSampler=l;let t=l;l=o,o=t,s.shader.bind(this),s.geometry.draw(5)}this.state.blend=!0,e.applyFilter(this,l,i,a),e.returnFilterTexture(r)}}get blur(){return this.strength}set blur(e){this.padding=1+2*Math.abs(e),this.strength=e}get quality(){return this._quality}set quality(e){this._quality=e,this.passes=e}}let T={5:[.153388,.221461,.250301],7:[.071303,.131514,.189879,.214607],9:[.028532,.067234,.124009,.179044,.20236],11:[.0093,.028002,.065984,.121703,.175713,.198596],13:[.002406,.009255,.027867,.065666,.121117,.174868,.197641],15:[489e-6,.002403,.009246,.02784,.065602,.120999,.174697,.197448]},C=`
    ...
    void main(void)
    {
        ...
        %blur%
    }`;class w extends PIXI.filters.ShockwaveFilter{constructor(t){super(),this.enabled=!1,this.time=0,this.amplitude=5,this.wavelength=100,this.speed=50,this.brightness=1.5,this.radius=200,this.zOrder=220,this.animated={},this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams())}handleTransform(e){this.center[0]=.5*e.sourceFrame.width,this.center[1]=.5*e.sourceFrame.height}}class P extends PIXI.filters.BulgePinchFilter{constructor(t){super(),this.strength=0,this.radiusPercent=100,this.zOrder=140,this.autoFit=!1,this.animated={},this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams()),this.center=[.5,.5]}handleTransform(){this.radius=Math.max(this.placeableImg.width,this.placeableImg.height)*this.targetPlaceable.worldTransform.a*this.radiusPercent/200}}let I=`
precision mediump float;
varying vec2 vTextureCoord;
uniform sampler2D uSampler;
...
void main() {
    ...
    gl_FragColor = color;
}`,eP={MAIN:"tmfx-main",TEMPLATE:"tmfx-template"};var eI=[];let eM=[{filterType:"bevel",filterId:"bevel",rotation:0,thickness:5,lightColor:16711680,lightAlpha:.8,shadowColor:65280,shadowAlpha:.5,animated:{rotation:{active:!0,clockWise:!0,loopDuration:1600,animType:"syncRotation"}}}];var eF={};eF.name="bevel",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"adjustment",filterId:"adjustment",saturation:1.5,brightness:1.5,contrast:2,gamma:2,red:4,green:.25,blue:.25,alpha:1,animated:{alpha:{active:!0,loopDuration:5e3,animType:"syncCosOscillation",val1:.15,val2:1}}}],(eF={}).name="adjustment",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"shadow",filterId:"dropshadow",rotation:35,blur:2,quality:5,distance:20,alpha:.7,padding:10,shadowOnly:!1,color:0}],(eF={}).name="dropshadow",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"outline",filterId:"outline",padding:10,color:15622197,thickness:1,quality:5,animated:{thickness:{active:!0,loopDuration:800,animType:"syncCosOscillation",val1:1,val2:6}}}],(eF={}).name="outline",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"glow",filterId:"glow",outerStrength:7,innerStrength:0,color:24576,quality:.5,padding:10,animated:{color:{active:!0,loopDuration:3e3,animType:"colorOscillation",val1:12288,val2:65280}}}],(eF={}).name="glow",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"xbloom",filterId:"bloom",threshold:.35,bloomScale:0,brightness:1,blur:.1,padding:10,quality:15,blendMode:0,animated:{bloomScale:{active:!0,loopDuration:2e3,animType:"syncCosOscillation",val1:0,val2:2.1},threshold:{active:!1,loopDuration:1e3,animType:"syncCosOscillation",val1:0,val2:1.9}}}],(eF={}).name="bloom",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"distortion",filterId:"distortion",maskPath:"modules/tokenmagic/fx/assets/distortion-1.png",maskSpriteScaleX:5,maskSpriteScaleY:5,padding:20,animated:{maskSpriteX:{active:!0,speed:.05,animType:"move"},maskSpriteY:{active:!0,speed:.07,animType:"move"}}}],(eF={}).name="distortion",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"oldfilm",filterId:"oldfilm",sepia:.6,noise:.2,noiseSize:1,scratch:.8,scratchDensity:.5,scratchWidth:1.2,vignetting:.9,vignettingAlpha:.6,vignettingBlur:.2,animated:{seed:{active:!0,animType:"randomNumber",val1:0,val2:1},vignetting:{active:!0,animType:"syncCosOscillation",loopDuration:2e3,val1:.2,val2:.4}}},{filterType:"outline",filterId:"oldfilm",color:0,thickness:0}],(eF={}).name="oldfilm",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"twist",filterId:"twist",radiusPercent:120,angle:0,animated:{angle:{active:!0,animType:"sinOscillation",loopDuration:1e4,val1:-.6*Math.PI,val2:.6*Math.PI}}}],(eF={}).name="twist",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"bulgepinch",filterId:"bulge",padding:150,strength:0,zIndex:2,radiusPercent:200,animated:{strength:{active:!0,animType:"cosOscillation",loopDuration:2e3,val1:0,val2:.45}}}],(eF={}).name="bulge",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"blur",filterId:"blur",padding:10,quality:4,blur:0,blurX:0,blurY:0,animated:{blurX:{active:!0,animType:"syncCosOscillation",loopDuration:500,val1:0,val2:6},blurY:{active:!0,animType:"syncCosOscillation",loopDuration:750,val1:0,val2:6}}}],(eF={}).name="blur",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"zoomblur",filterId:"zoomblur",strength:.15,innerRadiusPercent:65,radiusPercent:100,padding:30,animated:{innerRadiusPercent:{active:!0,animType:"sinOscillation",loopDuration:500,val1:65,val2:75}}}],(eF={}).name="zoomblur",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"shockwave",filterId:"shockwave",time:0,amplitude:8,wavelength:75,radius:500,brightness:1.5,speed:25,padding:0,animated:{time:{animType:"cosOscillation",active:!0,loopDuration:1800,val1:0,val2:10}}}],(eF={}).name="shockwave",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"zapshadow",filterId:"zapshadow",alphaTolerance:.45}],(eF={}).name="zapshadow",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"ray",filterId:"rays",time:0,color:13598720,alpha:.5,divisor:32,anchorX:0,anchorY:0,animated:{time:{active:!0,speed:5e-4,animType:"move"}}}],(eF={}).name="rays",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"fog",filterId:"fog",color:0,density:.65,time:0,dimX:1,dimY:1,animated:{time:{active:!0,speed:2.2,animType:"move"}}}],(eF={}).name="fog",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"fumes",filterId:"fumes",color:8421504,time:0,blend:8,animated:{time:{active:!0,speed:.001,animType:"move"}}}],(eF={}).name="fumes",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"electric",filterId:"electric",color:16777215,time:0,blend:1,intensity:5,animated:{time:{active:!0,speed:.002,animType:"move"}}}],(eF={}).name="electric",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"fire",filterId:"fire",intensity:1,color:16777215,amplitude:1,time:0,blend:2,fireBlend:1,animated:{time:{active:!0,speed:-.0024,animType:"move"},intensity:{active:!0,loopDuration:15e3,val1:.8,val2:2,animType:"syncCosOscillation"},amplitude:{active:!0,loopDuration:4400,val1:1,val2:1.4,animType:"syncCosOscillation"}}}],(eF={}).name="fire",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"wave",filterId:"waves",time:0,anchorX:.5,anchorY:.5,strength:.015,frequency:120,color:16777215,maxIntensity:2.5,minIntensity:.9,padding:10,animated:{time:{active:!0,speed:.0085,animType:"move"},anchorX:{active:!1,val1:.15,val2:.85,animType:"syncChaoticOscillation",loopDuration:2e4},anchorY:{active:!1,val1:.15,val2:.85,animType:"syncSinOscillation",loopDuration:2e4}}}],(eF={}).name="waves",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"flood",filterId:"flood",time:0,color:8379,billowy:.43,tintIntensity:.72,glint:.31,scale:70,padding:10,animated:{time:{active:!0,speed:6e-4,animType:"move"}}}],(eF={}).name="flood",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"smoke",filterId:"smoke",color:5282269,time:0,blend:2,dimX:.1,dimY:1,animated:{time:{active:!0,speed:.009,animType:"move"}}}],(eF={}).name="smoke",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"images",filterId:"images",time:0,nbImage:4,alphaImg:1,alphaChr:0,blend:4,ampX:.1,ampY:.1,animated:{time:{active:!0,speed:.001,animType:"move"}}}],(eF={}).name="images",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"images",filterId:"chaos-images",time:0,nbImage:4,alphaImg:1,alphaChr:0,blend:4,ampX:.1,ampY:.1,padding:80,animated:{time:{active:!0,speed:.001,animType:"move"},ampX:{active:!0,val1:0,val2:.3,chaosFactor:.03,animType:"syncChaoticOscillation",loopDuration:2e3},ampY:{active:!0,val1:0,val2:.3,chaosFactor:.04,animType:"syncChaoticOscillation",loopDuration:1650},alphaChr:{active:!0,animType:"randomNumberPerLoop",val1:0,val2:1,loopDuration:250},alphaImg:{active:!0,animType:"randomNumberPerLoop",val1:.8,val2:1,loopDuration:250},nbImage:{active:!0,val1:1,val2:9,animType:"syncSinOscillation",loopDuration:1400}}}],(eF={}).name="chaos-images",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"images",filterId:"spectral-images",time:0,blend:4,nbImage:4,padding:100,alphaImg:.5,alphaChr:0,ampX:.1,ampY:.1,animated:{time:{speed:.001,animType:"move"},ampX:{val1:0,val2:.22,animType:"syncCosOscillation",loopDuration:2500},ampY:{val1:0,val2:.24,animType:"syncCosOscillation",loopDuration:2500,pauseBetweenDuration:2500},alphaChr:{val1:1,val2:0,animType:"syncCosOscillation",loopDuration:2500},alphaImg:{val1:.2,val2:.8,animType:"syncSinOscillation",loopDuration:2500}}}],(eF={}).name="spectral-images",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"hexa-field",shieldType:2,gridPadding:1.5,color:13369548,time:0,blend:3,intensity:1,lightAlpha:.5,lightSize:.5,scale:1,radius:1,chromatic:!1,animated:{time:{active:!0,speed:.0015,animType:"move"}}}],(eF={}).name="hexa-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"fire-field",shieldType:1,gridPadding:2,color:15041872,time:0,blend:2,intensity:1.15,lightAlpha:2,lightSize:.7,scale:1,radius:1,chromatic:!1,animated:{time:{active:!0,speed:.0015,animType:"move"}}}],(eF={}).name="fire-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"smoke-field",shieldType:3,gridPadding:1.5,color:6343792,time:0,blend:2,intensity:.9,lightAlpha:1,lightSize:.7,scale:1,radius:1,chromatic:!1,animated:{time:{active:!0,speed:.0015,animType:"move"}}}],(eF={}).name="smoke-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"earth-field",shieldType:4,gridPadding:2,color:12292208,time:0,blend:1,intensity:1.25,lightAlpha:1,lightSize:.7,scale:1,radius:1,chromatic:!1,animated:{time:{active:!0,speed:.0015,animType:"move"}}}],(eF={}).name="earth-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"earth-field-top",shieldType:5,gridPadding:3,color:11184810,time:0,blend:5,intensity:1.9,lightAlpha:1,lightSize:.7,scale:1,radius:1,zIndex:5,chromatic:!0,animated:{time:{active:!0,speed:.0015,animType:"move"}}}],(eF={}).name="earth-field-top",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"air-field",shieldType:6,gridPadding:1.2,color:7377066,time:0,blend:14,intensity:1,lightAlpha:1,lightSize:.7,scale:1,radius:1,chromatic:!1,animated:{time:{active:!0,speed:.0015,animType:"move"}}}],(eF={}).name="air-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"magic-field",shieldType:7,gridPadding:1,color:16777215,time:0,blend:10,intensity:.8,lightAlpha:1,lightSize:.45,scale:1,radius:1,chromatic:!1,animated:{time:{active:!0,speed:.0015,animType:"move"}}}],(eF={}).name="magic-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"chromatic-field",shieldType:8,gridPadding:2,color:11184810,time:0,blend:0,intensity:1,lightAlpha:0,lightSize:0,scale:1,radius:1,chromatic:!0,animated:{time:{active:!0,speed:.0045,animType:"move"}}}],(eF={}).name="chromatic-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"water-field",shieldType:9,gridPadding:1.2,color:2145262,time:0,blend:4,intensity:1,lightAlpha:.7,lightSize:.5,scale:.6,radius:1,chromatic:!1,animated:{time:{active:!0,speed:.0015,animType:"move"}}}],(eF={}).name="water-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"evil-field",shieldType:9,gridPadding:2,color:16723984,time:0,blend:5,intensity:1,lightAlpha:4,lightSize:.8,scale:.5,radius:1,chromatic:!1,animated:{time:{active:!0,speed:.0012,animType:"move"},lightSize:{val1:.4,val2:1.5,animType:"syncCosOscillation",loopDuration:5e3}}}],(eF={}).name="evil-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"grid-field",shieldType:11,gridPadding:2,color:52428,time:0,blend:2,intensity:1,lightAlpha:1,lightSize:.3,scale:.5,radius:1,chromatic:!1,animated:{time:{active:!0,speed:9e-4,animType:"move"}}}],(eF={}).name="grid-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"warp-field",shieldType:12,gridPadding:2,color:16777215,time:0,blend:2,intensity:1,lightAlpha:.8,lightSize:.5,scale:.9,radius:1,chromatic:!1,animated:{time:{active:!0,speed:9e-4,animType:"move"}}}],(eF={}).name="warp-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"field",filterId:"color-field",shieldType:13,gridPadding:2,color:52224,time:0,blend:14,intensity:1,lightAlpha:0,lightSize:0,scale:1,radius:1,chromatic:!1,animated:{time:{active:!0,speed:9e-4,animType:"move"}}}],(eF={}).name="color-field",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"xray",filterId:"sunburst",time:0,color:16759552,blend:9,dimX:1,dimY:1,anchorX:0,anchorY:0,divisor:36,intensity:4,animated:{time:{active:!0,speed:.0012,animType:"move"},anchorX:{animType:"syncCosOscillation",loopDuration:6e3,val1:.4,val2:.6}}}],(eF={}).name="sunburst",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"xray",filterId:"clover",time:0,color:65280,blend:9,dimX:.05,dimY:.05,anchorX:.5,anchorY:.5,divisor:4,intensity:1,animated:{time:{active:!0,speed:.0012,animType:"move"},anchorX:{animType:"syncCosOscillation",loopDuration:6e3,val1:.4,val2:.6},anchorY:{animType:"syncSinOscillation",loopDuration:6e3,val1:.4,val2:.6}}}],(eF={}).name="clover",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"xray",filterId:"scan",time:0,color:16777215,blend:5,dimX:20,dimY:20,anchorX:.5,anchorY:0,divisor:8,intensity:1,animated:{time:{active:!0,speed:5e-4,animType:"move"}}}],(eF={}).name="scan",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"xray",filterId:"blue-rays",time:0,color:1061119,blend:9,dimX:1,dimY:1,anchorX:0,anchorY:0,divisor:24,intensity:1,animated:{time:{active:!0,speed:2e-4,animType:"move"},anchorX:{animType:"syncCosOscillation",loopDuration:18e3,val1:.05,val2:.95},anchorY:{animType:"syncSinOscillation",loopDuration:18e3,val1:.05,val2:.95}}}],(eF={}).name="blue-rays",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"liquid",filterId:"spectral-body",color:2140910,time:0,blend:8,intensity:4,spectral:!0,scale:.9,animated:{time:{active:!0,speed:.001,animType:"move"},color:{active:!0,loopDuration:6e3,animType:"colorOscillation",val1:16777215,val2:43775}}}],(eF={}).name="spectral-body",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"liquid",filterId:"mantle-of-madness",color:37119,time:0,blend:5,intensity:1e-4,spectral:!1,scale:7,animated:{time:{active:!0,speed:.0015,animType:"move"},intensity:{active:!0,animType:"syncCosOscillation",loopDuration:3e4,val1:1e-4,val2:4},scale:{active:!0,animType:"syncCosOscillation",loopDuration:3e4,val1:7,val2:1}}}],(eF={}).name="mantle-of-madness",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"wave",filterId:"drift-in-plans",time:0,anchorX:.5,anchorY:.5,strength:.035,frequency:80,color:16777215,maxIntensity:1.5,minIntensity:.5,padding:10,animated:{time:{active:!0,speed:.0085,animType:"move"},anchorX:{active:!0,val1:.35,val2:.65,animType:"syncCosOscillation",loopDuration:1e4},anchorY:{active:!0,val1:.35,val2:.65,animType:"syncSinOscillation",loopDuration:1e4}}},{filterType:"liquid",filterId:"drift-in-plans",color:16711680,time:0,blend:6,intensity:5,spectral:!1,scale:2.5,animated:{time:{active:!0,speed:.0018,animType:"move"},color:{active:!0,loopDuration:9e3,animType:"colorOscillation",val1:16711680,val2:16777215}}}],(eF={}).name="drift-in-plans",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"zapshadow",filterId:"fire-aura",alphaTolerance:.5},{filterType:"xglow",filterId:"fire-aura",auraType:2,color:9449488,thickness:9.8,scale:4,time:0,auraIntensity:2,subAuraIntensity:1.5,threshold:.4,discard:!0,animated:{time:{active:!0,speed:.0027,animType:"move"},thickness:{active:!0,loopDuration:3e3,animType:"cosOscillation",val1:2,val2:5}}}],(eF={}).name="fire-aura",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"zapshadow",filterId:"glacial-aura",alphaTolerance:.5},{filterType:"xglow",filterId:"glacial-aura",auraType:1,color:5282269,thickness:4.5,scale:3,time:0,auraIntensity:.8,subAuraIntensity:.25,threshold:.5,discard:!1,animated:{time:{active:!0,speed:.0018,animType:"move"},thickness:{val1:2,val2:4.7,animType:"cosOscillation",loopDuration:3e3},subAuraIntensity:{val1:.45,val2:.65,animType:"cosOscillation",loopDuration:6e3},auraIntensity:{val1:.9,val2:2.2,animType:"cosOscillation",loopDuration:3e3}}}],(eF={}).name="glacial-aura",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"zapshadow",filterId:"anti-aura",alphaTolerance:.5},{filterType:"xglow",filterId:"anti-aura",auraType:2,color:328965,thickness:2.7,scale:7,time:0,auraIntensity:5,subAuraIntensity:2,threshold:.08,discard:!1,animated:{time:{active:!0,speed:.0012,animType:"move"},auraIntensity:{active:!0,loopDuration:3e3,animType:"syncCosOscillation",val1:5,val2:0},subAuraIntensity:{active:!0,loopDuration:3e3,animType:"syncCosOscillation",val1:2,val2:0},color:{active:!0,loopDuration:6e3,animType:"syncColorOscillation",val1:328965,val2:2097152},threshold:{active:!0,loopDuration:1500,animType:"syncCosOscillation",val1:.02,val2:.5}}}],(eF={}).name="anti-aura",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"fire",filterId:"pure-fire-aura",intensity:1,color:16777215,amplitude:1,time:0,blend:2,fireBlend:1,animated:{time:{active:!0,speed:-.0024,animType:"move"},intensity:{active:!0,loopDuration:15e3,val1:.8,val2:2,animType:"syncCosOscillation"},amplitude:{active:!0,loopDuration:4400,val1:1,val2:1.4,animType:"syncCosOscillation"}}},{filterType:"zapshadow",filterId:"pure-fire-aura",alphaTolerance:.5},{filterType:"xglow",filterId:"pure-fire-aura",auraType:2,color:9449488,thickness:9.8,scale:4,time:0,auraIntensity:2,subAuraIntensity:1.5,threshold:.4,discard:!0,animated:{time:{active:!0,speed:.0027,animType:"move"},thickness:{active:!0,loopDuration:3e3,animType:"cosOscillation",val1:2,val2:5}}}],(eF={}).name="pure-fire-aura",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"zapshadow",filterId:"pure-fire-aura-2",alphaTolerance:.5},{filterType:"xglow",filterId:"pure-fire-aura-2",auraType:2,color:9449488,thickness:9.8,scale:4,time:0,auraIntensity:1,subAuraIntensity:.3,threshold:.5,discard:!0,animated:{time:{active:!0,speed:.0027,animType:"move"},thickness:{active:!0,loopDuration:3e3,animType:"cosOscillation",val1:2,val2:3.6}}},{filterType:"fire",filterId:"pure-fire-aura-2",intensity:1,color:16777215,amplitude:1,time:0,blend:2,fireBlend:1,animated:{time:{active:!0,speed:-.0024,animType:"move"},intensity:{active:!0,loopDuration:15e3,val1:.8,val2:3,animType:"syncCosOscillation"},amplitude:{active:!0,loopDuration:4400,val1:1,val2:1.6,animType:"syncCosOscillation"}}}],(eF={}).name="pure-fire-aura-2",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"zapshadow",filterId:"pure-ice-aura",alphaTolerance:.5},{filterType:"xglow",filterId:"pure-ice-aura",auraType:1,color:5282269,thickness:4.5,scale:10,time:0,auraIntensity:.25,subAuraIntensity:1,threshold:.5,discard:!1,animated:{time:{active:!0,speed:.0018,animType:"move"},thickness:{val1:2,val2:3.3,animType:"cosOscillation",loopDuration:3e3},subAuraIntensity:{val1:.45,val2:.65,animType:"cosOscillation",loopDuration:6e3},auraIntensity:{val1:.9,val2:2.2,animType:"cosOscillation",loopDuration:3e3}}},{filterType:"smoke",filterId:"pure-ice-aura",color:8441087,time:0,blend:2,dimX:.3,dimY:1,animated:{time:{active:!0,speed:-.006,animType:"move"},dimX:{val1:.4,val2:.2,animType:"cosOscillation",loopDuration:3e3}}}],(eF={}).name="pure-ice-aura",eF.library=eP.MAIN,eF.params=eM,eI.push(eF),eM=[{filterType:"pixel",filterId:"pixelate",sizeX:2.5,sizeY:2.5}],(eF={}).name="pixelate",eF.library=eP.MAIN,eF.params=eM,eI.push(eF);var ek=[];eM=[{filterType:"flood",filterId:"Watery Surface",time:0,color:8379,billowy:.43,tintIntensity:.72,glint:.31,scale:70,padding:10,animated:{time:{active:!0,speed:6e-4,animType:"move"}}}],(eF={}).name="Watery Surface",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"liquid",filterId:"Protoplasm",color:2140910,time:0,blend:8,intensity:4,spectral:!0,scale:1.4,animated:{time:{active:!0,speed:.001,animType:"move"}}}],(eF={}).name="Protoplasm",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"liquid",filterId:"Watery Surface 2",color:2140910,time:0,blend:8,intensity:4,spectral:!1,scale:1.4,animated:{time:{active:!0,speed:.001,animType:"move"}}}],(eF={}).name="Watery Surface 2",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/white-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"smoke",filterId:"Smoky Area",color:11184810,time:0,blend:2,dimX:1,dimY:1,animated:{time:{active:!0,speed:.002,animType:"move"}}}],(eF={}).name="Smoky Area",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"electric",filterId:"Shock",color:16777215,time:0,blend:1,intensity:5,animated:{time:{active:!0,speed:.002,animType:"move"}}}],(eF={}).name="Shock",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/white-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"xray",filterId:"Annihilating Rays",time:0,color:16759552,blend:9,dimX:1,dimY:1,anchorX:0,anchorY:0,divisor:6,intensity:4,animated:{time:{active:!0,speed:.0012,animType:"move"}}}],(eF={}).name="Annihilating Rays",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/white-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"ray",filterId:"Classic Rays",time:0,color:13598720,alpha:.5,divisor:32,anchorX:0,anchorY:0,animated:{time:{active:!0,speed:5e-4,animType:"move"}}}],(eF={}).name="Classic Rays",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"fumes",filterId:"Smoke Filaments",color:8421504,time:0,blend:8,animated:{time:{active:!0,speed:.001,animType:"move"}}}],(eF={}).name="Smoke Filaments",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"fire",filterId:"Flames",intensity:1.5,color:16777215,amplitude:1.3,time:0,blend:2,fireBlend:1,animated:{time:{active:!0,speed:-.0016,animType:"move"}}}],(eF={}).name="Flames",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"xfog",filterId:"Thick Fog",autoFit:!1,color:3182847,time:0,animated:{time:{active:!0,speed:6e-4,animType:"move"}}}],(eF={}).name="Thick Fog",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-vstrong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"glow",filterId:"Glowing Outline",outerStrength:5.5,innerStrength:0,color:24576,quality:.5,padding:10,animated:{outerStrength:{active:!0,loopDuration:3e3,animType:"syncCosOscillation",val1:5.5,val2:1.5}}}],(eF={}).name="Glowing Outline",eF.library=eP.TEMPLATE,eF.params=eM,ek.push(eF),eM=[{filterType:"wave",filterId:"Waves",time:0,anchorX:.5,anchorY:.5,strength:.015,frequency:120,color:16777215,maxIntensity:2.5,minIntensity:.9,padding:10,animated:{time:{active:!0,speed:.0085,animType:"move"}}}],(eF={}).name="Waves",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/white-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"wave",filterId:"Waves 2",time:0,anchorX:.5,anchorY:.5,strength:.014,frequency:400,color:16777215,maxIntensity:2.4,minIntensity:.8,padding:10,animated:{time:{active:!0,speed:.0385,animType:"move"}}}],(eF={}).name="Waves 2",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/white-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"wave",filterId:"Waves 3",time:0,anchorX:.5,anchorY:.5,strength:.017,frequency:35,color:16777215,maxIntensity:2.6,minIntensity:.9,padding:20,animated:{time:{active:!0,speed:.0085,animType:"move"}}}],(eF={}).name="Waves 3",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/white-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"xglow",filterId:"Zone : Fire",auraType:1,color:9449488,scale:1.5,time:0,auraIntensity:1.8,subAuraIntensity:.25,threshold:.6,discard:!1,animated:{time:{active:!0,speed:.0027,animType:"move"},thickness:{active:!0,loopDuration:3e3,animType:"cosOscillation",val1:2,val2:5}}},{filterType:"fire",filterId:"Zone : Fire",intensity:1.5,color:16777215,amplitude:1,time:0,blend:2,fireBlend:1,animated:{time:{active:!0,speed:-.0015,animType:"move"}}}],(eF={}).name="Zone : Fire",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"xglow",filterId:"Zone : Electricity",auraType:2,color:3158064,scale:1.5,time:0,auraIntensity:1,subAuraIntensity:.9,threshold:0,discard:!0,animated:{time:{active:!0,speed:.0027,animType:"move"},thickness:{active:!0,loopDuration:3e3,animType:"cosOscillation",val1:1,val2:2}}},{filterType:"electric",filterId:"Zone : Electricity",color:16777215,time:0,blend:1,intensity:5,animated:{time:{active:!0,speed:.002,animType:"move"}}}],(eF={}).name="Zone : Electricity",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/white-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"xglow",filterId:"Zone : Blizzard",auraType:1,color:5282269,thickness:4.5,scale:5,time:0,auraIntensity:.25,subAuraIntensity:1,threshold:.5,discard:!1,animated:{time:{active:!0,speed:.0018,animType:"move"},thickness:{val1:2,val2:3.3,animType:"cosOscillation",loopDuration:3e3},subAuraIntensity:{val1:.05,val2:.1,animType:"cosOscillation",loopDuration:6e3},auraIntensity:{val1:.9,val2:2.2,animType:"cosOscillation",loopDuration:3e3}}},{filterType:"smoke",filterId:"Zone : Blizzard",color:8441087,time:0,blend:2,dimY:1,animated:{time:{active:!0,speed:-.005,animType:"move"},dimX:{val1:.4,val2:.2,animType:"cosOscillation",loopDuration:3e3}}}],(eF={}).name="Zone : Blizzard",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"bulgepinch",filterId:"Bulging Out",padding:150,strength:0,radiusPercent:200,animated:{strength:{active:!0,animType:"cosOscillation",loopDuration:2e3,val1:0,val2:.45}}}],(eF={}).name="Bulging Out",eF.library=eP.TEMPLATE,eF.params=eM,ek.push(eF),eM=[{filterType:"blur",filterId:"Blurred Texture",padding:25,quality:4,blur:0,blurX:0,blurY:0,animated:{blurX:{active:!0,animType:"syncCosOscillation",loopDuration:500,val1:0,val2:6},blurY:{active:!0,animType:"syncCosOscillation",loopDuration:750,val1:0,val2:6}}}],(eF={}).name="Blurred Texture",eF.library=eP.TEMPLATE,eF.params=eM,ek.push(eF),eM=[{filterType:"xbloom",filterId:"Bloomed Texture",threshold:.35,bloomScale:0,brightness:1,blur:.1,padding:10,quality:15,blendMode:0,animated:{bloomScale:{active:!0,loopDuration:2e3,animType:"syncCosOscillation",val1:0,val2:2.1},threshold:{active:!1,loopDuration:1e3,animType:"syncCosOscillation",val1:0,val2:1.9}}}],(eF={}).name="Bloomed Texture",eF.library=eP.TEMPLATE,eF.params=eM,ek.push(eF),eM=[{filterType:"liquid",filterId:"Wild Magic",color:16711680,time:0,blend:6,intensity:5,spectral:!1,scale:2.5,animated:{time:{active:!0,speed:.0018,animType:"move"}}},{filterType:"wave",filterId:"Wild Magic",time:0,anchorX:.5,anchorY:.5,strength:.014,frequency:10,color:16777215,maxIntensity:1.3,minIntensity:.6,padding:10,animated:{time:{active:!0,speed:.0065,animType:"move"}}}],(eF={}).name="Wild Magic",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"web",filterId:"Spider Web 1",anchorX:.5,anchorY:.5,color:16777215,thickness:2,div2:5,time:98.8,animated:{time:{active:!0,loopDuration:5e3,animType:"cosOscillation",val1:98.8,val2:99.7}}}],(eF={}).name="Spider Web 1",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"web",filterId:"Spider Web 2",anchorX:.5,anchorY:.5,color:13421772,animated:{time:{active:!0,speed:5e-4,animType:"move"}}},{filterType:"liquid",filterId:"Spider Web 2",color:16711680,time:0,blend:4,intensity:8,spectral:!1,scale:.2,animated:{time:{active:!0,speed:5e-4,animType:"move"}}}],(eF={}).name="Spider Web 2",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF),eM=[{filterType:"web",filterId:"Spider Web 3",anchorX:.5,anchorY:.5,color:13421772,time:100},{filterType:"liquid",filterId:"Spider Web 3",color:16711680,time:0,blend:1,intensity:4,spectral:!0,scale:.2,animated:{time:{active:!0,speed:5e-4,animType:"move"}}}],(eF={}).name="Spider Web 3",eF.library=eP.TEMPLATE,eF.defaultTexture="modules/tokenmagic/fx/assets/templates/black-tone-strong-opacity.png",eF.params=eM,ek.push(eF);var eS=eI.concat(ek);let e_=tb(),eA={ARCHAIC:"",V030:"0.3.0",V040:"0.4.0",V040b:"0.4.0b",V041:"0.4.1",V043:"0.4.3"};async function eO(){if(tr()){var e;try{e=game.settings.get("tokenmagic","migration")}catch(t){e=eA.ARCHAIC}e<eA.V030&&await eX(),e<eA.V040&&await ez(),e<eA.V040b&&await eD(),e<eA.V041&&await eE(),e<eA.V043&&await eR()}}async function eX(){var e=game.settings.get("tokenmagic","presets");if(null!=e){tc("Migration 0.3.0 - Launching presets data migration...");let t=!1;for(let i of e)i.hasOwnProperty("library")?i.library!==eP.TEMPLATE||t||(t=!0,tc("Migration 0.3.0 - Found template presets. Templates will not be added.")):(i.library=eP.MAIN,tc(`Migration 0.3.0 - Adding ${i.name} to ${eP.MAIN}`));t||tc("Migration 0.3.0 - Merging templates presets.");let i=t?e:e.concat(ek);try{await game.settings.set("tokenmagic","presets",i),await game.settings.set("tokenmagic","migration",eA.V030),tc("Migration 0.3.0 - Migration successful!")}catch(e){tu("Migration 0.3.0 - Migration failed."),tu(e)}}}async function ez(){var e=game.settings.get("tokenmagic","presets");if(null!=e){for(let t of(tc("Migration 0.4.0 - Launching presets data migration..."),e))if(t.library===eP.TEMPLATE){tc(`Migration 0.4.0 - Checking template preset ${t.name}...`);let e=1;for(let i of t.params)!i.hasOwnProperty("zOrder")&&(i.zOrder=e,tc(`Migration 0.4.0 - Updating ${i.filterType} in ${t.name}...`),e++)}try{await game.settings.set("tokenmagic","presets",e),tc("Migration 0.4.0 - Importing new template presets..."),await e_.importPresetLibraryFromPath("modules/tokenmagic/import/TMFX-update-presets-v040.json",{overwrite:!1}),await game.settings.set("tokenmagic","migration",eA.V040),tc("Migration 0.4.0 - Migration successful!")}catch(e){tu("Migration 0.4.0 - Migration failed."),tu(e)}}}async function eD(){var e=game.settings.get("tokenmagic","presets");if(null!=e){tc("Migration 0.4.0b - Launching presets data migration...");try{await game.settings.set("tokenmagic","presets",e),tc("Migration 0.4.0b - updating template presets..."),await e_.importPresetLibraryFromPath("modules/tokenmagic/import/TMFX-update-presets-v040b.json",{overwrite:!0}),await game.settings.set("tokenmagic","migration",eA.V040b),tc("Migration 0.4.0b - Migration successful!")}catch(e){tu("Migration 0.4.0b - Migration failed."),tu(e)}}}async function eE(){var e=game.settings.get("tokenmagic","presets");if(null!=e){tc("Migration 0.4.1 - Launching presets data migration...");try{await game.settings.set("tokenmagic","presets",e),tc("Migration 0.4.1 - updating template presets..."),await e_.importPresetLibraryFromPath("modules/tokenmagic/import/TMFX-update-presets-v041.json",{overwrite:!0}),await game.settings.set("tokenmagic","migration",eA.V041),tc("Migration 0.4.1 - Migration successful!")}catch(e){tu("Migration 0.4.1 - Migration failed."),tu(e)}}}async function eR(){var e=game.settings.get("tokenmagic","presets");if(null!=e){tc("Migration 0.4.3 - Launching presets data migration...");try{await game.settings.set("tokenmagic","presets",e),tc("Migration 0.4.3 - updating template presets..."),await e_.importPresetLibraryFromPath("modules/tokenmagic/import/TMFX-update-presets-v043.json",{overwrite:!0}),await game.settings.set("tokenmagic","migration",eA.V043),tc("Migration 0.4.3 - Migration successful!")}catch(e){tu("Migration 0.4.3 - Migration failed."),tu(e)}}}class eY extends PIXI.filters.CRTFilter{constructor(t){super(),this.curvature=1,this.lineWidth=1,this.lineContrast=.25,this.verticalLine=!1,this.noise=.08,this.noiseSize=1,this.seed=0,this.vignetting=0,this.zOrder=320,this.animated={},this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams())}}class eL extends PIXI.filters.RGBSplitFilter{constructor(t){super(),this.red=new Float32Array([-10,0]),this.green=new Float32Array([0,10]),this.blue=new Float32Array([0,0]),this.zOrder=340,this.animated={},this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams())}get redX(){return this.uniforms.red[0]}set redX(e){this.uniforms.red[0]=e}get redY(){return this.uniforms.red[1]}set redY(e){this.uniforms.red[1]=e}get greenX(){return this.uniforms.green[0]}set greenX(e){this.uniforms.green[0]=e}get greenY(){return this.uniforms.green[1]}set greenY(e){this.uniforms.green[1]=e}get blueX(){return this.uniforms.blue[0]}set blueX(e){this.uniforms.blue[0]=e}get blueY(){return this.uniforms.blue[1]}set blueY(e){this.uniforms.blue[1]=e}}let{HandlebarsApplicationMixin:ej,ApplicationV2:eN}=foundry.applications.api;class eq extends ej(eN){static DEFAULT_OPTIONS={id:"tmfx-template-settings",tag:"form",window:{icon:"fa-solid fa-fire",title:"TMFX.settings.autoTemplateSettings.dialog.title",contentClasses:["standard-form"]},classes:["tokenmagic","settings"],position:{width:600},form:{handler:eq._onSubmit,submitOnChange:!0,closeOnSubmit:!1},actions:{addOverride:eq._onAddOverride,removeOverride:eq._onRemoveOverride}};static TABS={main:{tabs:[{id:"categories",icon:"fa-regular fa-book-open"},{id:"overrides",icon:"fa-solid fa-circle-plus"}],initial:"categories",labelPrefix:"TMFX.settings.autoTemplateSettings.tabs"}};async _preparePartContext(e,t,i){return t.partId=e,e in t.tabs&&(t.tab=t.tabs[e]),t}async _prepareContext(e){return Object.assign(await super._prepareContext(e),{emptyPreset:t,presets:[{name:t},...ty.getPresets(eP.TEMPLATE).sort(function(e,t){return e.name<t.name?-1:e.name>t.name?1:0})],system:{id:game.system.id,title:game.system.title},settings:{autoTemplateEnable:game.settings.get("tokenmagic","autoTemplateEnabled"),autoTemplateSettings:game.settings.get("tokenmagic","autoTemplateSettings")},submitText:game.i18n.localize("TMFX.save")})}static async _onSubmit(e,t,i){for(let[e,t]of Object.entries(foundry.utils.expandObject(i.object))){if("autoTemplateSettings"===e&&t.overrides){let e={};Object.values(t.overrides).forEach((t,i)=>e[i]=t),t.overrides=e}await game.settings.set("tokenmagic",e,t)}}activateListeners(e){super.activateListeners(e),e.find("button.add-override").click(this._onAddOverride.bind(this)),e.find("button.remove-override").click(this._onRemoveOverride.bind(this))}static async _onAddOverride(e){let i;let a=await game.settings.get("tokenmagic","autoTemplateSettings"),r=Object.keys(a.overrides).map(e=>Number(e)).sort().at(-1);i=null==r?0:r+1,a.overrides[i]={target:"",opacity:.5,tint:null,preset:t,texture:null},await game.settings.set("tokenmagic","autoTemplateSettings",a),this.render(!0)}static async _onRemoveOverride(e){e.target.closest(".override-entry").remove(),await this.submit(),this.render()}}class eV extends eq{constructor(){super(),this._enabled=!1}static PARTS={tabs:{template:"templates/generic/tab-navigation.hbs"},categories:{template:"modules/tokenmagic/templates/settings/generic/categories.hbs"},overrides:{template:"modules/tokenmagic/templates/settings/generic/overrides.hbs"}};static get defaultConfiguration(){let e={categories:{},overrides:{0:{target:"Stinking Cloud",opacity:.5,tint:"#00a80b",preset:"Smoky Area",texture:null},1:{target:"Web",opacity:.5,tint:"#808080",preset:"Spider Web 2",texture:null}}};return Object.keys(CONFIG.DND5E.damageTypes).forEach(i=>{if(void 0==e.categories[i]){let t={opacity:.5,tint:null};switch(i.toLowerCase()){case"acid":t.tint="#2d8000",t.opacity=.6;break;case"cold":t.tint="#47b3ff";break;case"necrotic":t.tint="#502673";break;case"poison":t.tint="#00a80b";break;case"psychic":t.tint="#8000ff";break;case"thunder":t.tint="#0060ff"}e.categories[i]=t}Object.values(CONST.MEASURED_TEMPLATE_TYPES).forEach(a=>{let r={preset:t,texture:null};switch(i.toLowerCase()){case"acid":r.preset="Watery Surface 2";break;case"cold":r.preset="Thick Fog";break;case"fire":r.preset="Flames";break;case"force":r.preset="Waves 3";break;case"lightning":r.preset="Shock";break;case"necrotic":r.preset="Smoke Filaments";break;case"poison":r.preset="Smoky Area";break;case"psychic":r.preset="Classic Rays";break;case"radiant":r.preset="Annihilating Rays";break;case"thunder":r.preset="Waves"}e.categories[i][a]=r})}),e}get enabled(){return this._enabled}configure(e=!1){"dnd5e"===game.system.id&&(e?this._enabled||libWrapper.register("tokenmagic","game.dnd5e.canvas.AbilityTemplate.fromActivity",eW,"WRAPPER"):this._enabled&&libWrapper.unregister("tokenmagic","game.dnd5e.canvas.AbilityTemplate.fromActivity"),this._enabled=e)}async _preparePartContext(e,t,i){return await super._preparePartContext(e,t,i),"categories"===e&&this._prepareCategoriesContext(t,i),t}_prepareCategoriesContext(e,t){e.dmgTypes=CONFIG.DND5E.damageTypes,e.templateTypes=CONST.MEASURED_TEMPLATE_TYPES}}function eB(e,i){let a={tokenmagic:{options:{}}};e.preset&&""!==e.preset&&e.preset!==t&&(a.tokenmagic.options.tmfxPreset=e.preset),e.texture&&""!==e.texture&&(a.tokenmagic.options.tmfxTexture=e.texture),e.tint&&""!==e.tint&&(a.tokenmagic.options.tmfxTint=e.tint),a.tokenmagic.options.tmfxTextureAlpha=e.opacity,i.updateSource({flags:{tokenmagic:a.tokenmagic}})}function eW(e,...i){let[a]=i,r=e(...i);if(!r)return r;for(let e of r){let i=e.document;if(i.hasOwnProperty("tmfxPreset"))continue;let r=game.settings.get("tokenmagic","autoTemplateSettings");r.overrides&&function(e=[],t,i){if(!t.item)return!1;let a=e.filter(e=>e.target.toLowerCase()===t.item.name.toLowerCase());return 0!==a.length&&(eB(a[Math.floor(Math.random()*a.length)],i),!0)}(Object.values(r.overrides),a,i)||function(e={},i,a){let r,s;if(!i.item)return;let o=i.item;if(!(o.hasAttack||o.hasSave)&&!o.system.damage?.base?.types.size)return;let l=[];if(o.system?.damage?.base?.types&&(l=o.system.damage.base.types),!l.length&&o.system.activities){let e=o.system.activities.getByType("save");e.length&&(l=e.flatMap(e=>e.damage.parts.flatMap(e=>Array.from(e.types))))}for(let i of l)if((r=(s=e[i]||{})[a.t])&&r.preset!==t)break;r&&eB(foundry.utils.mergeObject(r,{opacity:s.opacity,tint:s.tint},!0,!0),a)}(r.categories,a,i)}return r}class e$ extends eq{constructor(){super(),this._enabled=!1}static PARTS={tabs:{template:"templates/generic/tab-navigation.hbs"},categories:{template:"modules/tokenmagic/templates/settings/generic/categories.hbs"},overrides:{template:"modules/tokenmagic/templates/settings/generic/overrides.hbs"}};static get defaultConfiguration(){let e={categories:{},overrides:{0:{target:"Stinking Cloud",opacity:.5,tint:"#00a80b",preset:"Smoky Area",texture:null},1:{target:"Sanguine Mist",opacity:.6,tint:"#c41212",preset:"Smoky Area"},2:{target:"Web",opacity:.5,tint:"#808080",preset:"Spider Web 2",texture:null},3:{target:"Incendiary Aura",opacity:.2,tint:"#b12910",preset:"Smoke Filaments",texture:null}}};return Object.keys(CONFIG.PF2E.damageTraits).forEach(i=>{if(void 0==e.categories[i]){let t={opacity:.5,tint:null};switch(i.toLowerCase()){case"acid":t.tint="#2d8000",t.opacity=.6;break;case"cold":t.tint="#47b3ff";break;case"electricity":case"fire":case"force":case"positive":break;case"mental":t.tint="#8000ff";break;case"negative":t.tint="#502673";break;case"poison":t.tint="#00a80b";break;case"sonic":t.tint="#0060ff"}e.categories[i]=t}Object.values(CONST.MEASURED_TEMPLATE_TYPES).forEach(a=>{let r={preset:t,texture:null};switch(i.toLowerCase()){case"acid":r.preset="Watery Surface 2";break;case"cold":r.preset="Thick Fog";break;case"electricity":r.preset="Shock";break;case"fire":r.preset="Flames";break;case"force":r.preset="Waves 3";break;case"mental":r.preset="Classic Rays";break;case"negative":r.preset="Smoke Filaments";break;case"poison":r.preset="Smoky Area";break;case"positive":r.preset="Annihilating Rays";break;case"sonic":r.preset="Waves"}e.categories[i][a]=r})}),e}configure(e=!1){"pf2e"===game.system.id&&(this._enabled=e)}get enabled(){return this._enabled}set enabled(e){}async _preparePartContext(e,t,i){return await super._preparePartContext(e,t,i),"categories"===e&&this._prepareCategoriesContext(t,i),t}_prepareCategoriesContext(e,t){let i={};for(let e of Object.keys(CONFIG.PF2E.damageTraits).sort((e,t)=>e.localeCompare(t)))i[e]={label:e.charAt(0).toUpperCase()+e.slice(1)};e.dmgTypes=i,e.templateTypes=CONST.MEASURED_TEMPLATE_TYPES}preCreateMeasuredTemplate(e){if(e.hasOwnProperty("tmfxPreset"))return e;let i=e.flags?.pf2e?.origin,a=game.settings.get("tokenmagic","autoTemplateSettings");return a.overrides&&function(e=[],t,i){let{name:a,slug:r}=t,s=e.filter(e=>e.target.toLowerCase()===a?.toLowerCase());return 0!==s.length&&(eU(s[Math.floor(Math.random()*s.length)],i),!0)}(Object.values(a.overrides),i,e)||function(e={},i,a){let r,s;if(!i.traits?.length)return 0;for(let o of i.traits)if((r=(s=e[o.toLowerCase()]||{})[a.t])&&r.preset!==t)break;r&&eU(foundry.utils.mergeObject(r,{opacity:s.opacity,tint:s.tint},!0,!0),a)}(a.categories,i,e),e}}function eU(e,i){let a={tokenmagic:{options:{}}};e.preset&&""!==e.preset&&e.preset!==t&&(a.tokenmagic.options.tmfxPreset=e.preset),e.texture&&""!==e.texture&&(a.tokenmagic.options.tmfxTexture=e.texture),e.tint&&""!==e.tint&&(a.tokenmagic.options.tmfxTint=e.tint),a.tokenmagic.options.tmfxTextureAlpha=e.opacity,i.updateSource({flags:{tokenmagic:a.tokenmagic}})}class eG extends eq{constructor(){super(),this._enabled=!1}static PARTS={tabs:{template:"templates/generic/tab-navigation.hbs"},categories:{template:"modules/tokenmagic/templates/settings/generic/categories.hbs"},overrides:{template:"modules/tokenmagic/templates/settings/generic/overrides.hbs"}};static get defaultConfiguration(){let e={categories:{},overrides:{0:{target:"Игни",opacity:.5,tint:"#00a80b",preset:"Flames",texture:null}}};return Object.keys(CONFIG.WITCHER.meleeSkills).forEach(i=>{if(void 0==e.categories[i]){let t={opacity:.5,tint:null};switch(i.toLowerCase()){case"brawling":t.tint="#2d8000",t.opacity=.6;break;case"melee":t.tint="#47b3ff";break;case"small blades":t.tint="#502673";break;case"staff/spear":t.tint="#00a80b";break;case"swordsmanship":t.tint="#8000ff";break;case"athletics":t.tint="#0060ff"}e.categories[i]=t}Object.values(CONST.MEASURED_TEMPLATE_TYPES).forEach(a=>{let r={preset:t,texture:null};switch(i.toLowerCase()){case"acid":r.preset="slashing";break;case"cold":r.preset="bludgeoning";break;case"fire":r.preset="piercing";break;case"force":r.preset="elemental"}e.categories[i][a]=r})}),e}get enabled(){return this._enabled}configure(e=!1){"TheWitcherTRPG"===game.system.id&&(this._enabled=e)}async _preparePartContext(e,t,i){return await super._preparePartContext(e,t,i),"categories"===e&&this._prepareCategoriesContext(t,i),t}_prepareCategoriesContext(e,t){let i={};for(let e of CONFIG.WITCHER.meleeSkills.sort((e,t)=>e.localeCompare(t)))i[e]={label:e.charAt(0).toUpperCase()+e.slice(1)};e.dmgTypes=i,e.templateTypes=CONST.MEASURED_TEMPLATE_TYPES}preCreateMeasuredTemplate(e){if(e.hasOwnProperty("tmfxPreset"))return e;let i=game.settings.get("tokenmagic","autoTemplateSettings");i.overrides&&function(e=[],t){let i=t.flags.witcher?.origin?.name,a=e.find(e=>e.target.toLowerCase()===i?.toLowerCase());return!!a&&(eH(a,t),!0)}(Object.values(i.overrides),e)||function(e={},i){let a,r;for(let s of i.flags.witcher?.origin?.traits??[])if((a=(r=e[s]||{})[i.t])&&a.preset!==t)break;a&&eH(foundry.utils.mergeObject(a,{opacity:r.opacity,tint:r.tint},!0,!0),i)}(i.categories,e)}}function eH(e,i){let a={tokenmagic:{options:{}}};e.preset&&""!==e.preset&&e.preset!==t&&(a.tokenmagic.options.tmfxPreset=e.preset),e.texture&&""!==e.texture&&(a.tokenmagic.options.tmfxTexture=e.texture),e.tint&&""!==e.tint&&(a.tokenmagic.options.tmfxTint=e.tint),a.tokenmagic.options.tmfxTextureAlpha=e.opacity,foundry.utils.mergeObject(i,{"flags.tokenmagic":a.tokenmagic})}let eZ=tb();class eK{static init(){let e=this.getSystemTemplateClass(),t=!!e;e&&(game.settings.registerMenu("tokenmagic","autoTemplateSettings",{name:game.i18n.localize("TMFX.settings.autoTemplateSettings.button.name"),label:game.i18n.localize("TMFX.settings.autoTemplateSettings.button.label"),hint:game.i18n.localize("TMFX.settings.autoTemplateSettings.button.hint"),type:e,restricted:!0}),game.settings.register("tokenmagic","autoTemplateSettings",{name:game.i18n.localize("TMFX.settings.autoTemplateSettings.name"),hint:game.i18n.localize("TMFX.settings.autoTemplateSettings.hint"),scope:"world",config:!1,default:e.defaultConfiguration,type:Object})),game.settings.register("tokenmagic","autoTemplateEnabled",{name:game.i18n.localize("TMFX.settings.autoTemplateEnabled.name"),hint:game.i18n.localize("TMFX.settings.autoTemplateEnabled.hint"),scope:"world",config:t,default:t,type:Boolean,onChange:e=>eK.configureAutoTemplate(e)}),game.settings.register("tokenmagic","defaultTemplateOnHover",{name:game.i18n.localize("TMFX.settings.defaultTemplateOnHover.name"),hint:game.i18n.localize("TMFX.settings.defaultTemplateOnHover.hint"),scope:"world",config:!0,default:t,type:Boolean,requiresReload:!0}),game.settings.register("tokenmagic","autohideTemplateElements",{name:game.i18n.localize("TMFX.settings.autohideTemplateElements.name"),hint:game.i18n.localize("TMFX.settings.autohideTemplateElements.hint"),scope:"world",config:!0,default:!0,type:Boolean,requiresReload:!0}),game.settings.register("tokenmagic","useAdditivePadding",{name:game.i18n.localize("TMFX.settings.useMaxPadding.name"),hint:game.i18n.localize("TMFX.settings.useMaxPadding.hint"),scope:"world",config:!0,default:!1,type:Boolean}),game.settings.register("tokenmagic","minPadding",{name:game.i18n.localize("TMFX.settings.minPadding.name"),hint:game.i18n.localize("TMFX.settings.minPadding.hint"),scope:"world",config:!0,default:50,type:Number}),game.settings.register("tokenmagic","fxPlayerPermission",{name:game.i18n.localize("TMFX.settings.fxPlayerPermission.name"),hint:game.i18n.localize("TMFX.settings.fxPlayerPermission.hint"),scope:"world",config:!0,default:!1,type:Boolean}),game.settings.register("tokenmagic","importOverwrite",{name:game.i18n.localize("TMFX.settings.importOverwrite.name"),hint:game.i18n.localize("TMFX.settings.importOverwrite.hint"),scope:"world",config:!0,default:!1,type:Boolean}),game.settings.register("tokenmagic","useZOrder",{name:game.i18n.localize("TMFX.settings.useZOrder.name"),hint:game.i18n.localize("TMFX.settings.useZOrder.hint"),scope:"world",config:!0,default:!1,type:Boolean}),game.settings.register("tokenmagic","disableAnimations",{name:game.i18n.localize("TMFX.settings.disableAnimations.name"),hint:game.i18n.localize("TMFX.settings.disableAnimations.hint"),scope:"client",config:!0,default:!1,type:Boolean,requiresReload:!0}),game.settings.register("tokenmagic","disableCaching",{name:game.i18n.localize("TMFX.settings.disableCaching.name"),hint:game.i18n.localize("TMFX.settings.disableCaching.hint"),scope:"client",config:!0,default:!0,type:Boolean}),game.settings.register("tokenmagic","disableVideo",{name:game.i18n.localize("TMFX.settings.disableVideo.name"),hint:game.i18n.localize("TMFX.settings.disableVideo.hint"),scope:"world",config:!0,default:!1,type:Boolean,requiresReload:!0}),game.settings.register("tokenmagic","presets",{name:"Token Magic FX presets",hint:"Token Magic FX presets",scope:"world",config:!1,default:eI,type:Object}),game.settings.register("tokenmagic","migration",{name:"TMFX Data Version",hint:"TMFX Data Version",scope:"world",config:!1,default:eA.ARCHAIC,type:String})}static configureAutoTemplate(e=!1){this.getSystemTemplates()?.configure(e)}static getSystemTemplates(){if(this._autoTemplate)return this._autoTemplate;let e=this.getSystemTemplateClass();return this._autoTemplate=e?new e:null,this._autoTemplate}static getSystemTemplateClass(){switch(game.system.id){case"dnd5e":return eV;case"pf2e":return e$;case"TheWitcherTRPG":return eG;default:return null}}}Hooks.once("init",()=>{let e,i,a;Handlebars.registerHelper("concat",function(...e){return"object"==typeof e[e.length-1]&&e.pop(),e.join("")}),eK.init(),eK.configureAutoTemplate(game.settings.get("tokenmagic","autoTemplateEnabled"));let r=async function(e,...i){let a,r;let[s]=i,o=s.texture??"",l=!!s.texture,n=s.flags?.tokenmagic?.options??null;if(n||(a=s["flags.tokenmagic.templateData.preset"]),r=!!a,l&&(s.texture=td(s.texture)),null==n){if(r&&a!==t){let e=eZ._getPresetTemplateDefaultTexture(a);null!=e&&(""===o||o.startsWith("modules/tokenmagic/fx/assets/templates/"))&&(s.texture=e)}else l&&o.startsWith("modules/tokenmagic/fx/assets/templates/")&&r&&a===t&&(document.texture="")}return await e(...i)},s=async function(e,...t){return this.document.texture&&(this.document.texture=td(this.document.texture)),await e(...t)};if(!ta()){let t=Math.toRadians;i="WRAPPER",e=function(e,...t){let[i]=t;return i?.refreshShape&&(i.refreshShape=this.template&&!this.template._destroyed),e(...t)},a=function(){let e=this.template.clear();if(this.isVisible){if(e.lineStyle(this._borderThickness,this.document.borderColor,.75).beginFill(0,0),this.texture){let i=PIXI.Matrix.IDENTITY;if(this.shape.width&&this.shape.height)i.scale(this.shape.width/this.texture.width,this.shape.height/this.texture.height);else if(this.shape.radius)i.scale(2*this.shape.radius/this.texture.height,2*this.shape.radius/this.texture.width),i.translate(-this.shape.radius,-this.shape.radius);else if("ray"===this.document.t){let e=canvas.dimensions,a=this.document.width*e.size/e.distance,r=this.document.distance*e.size/e.distance;i.scale(r/this.texture.width,a/this.texture.height),i.translate(0,-(.5*a)),i.rotate(t(this.document.direction))}else{let e=canvas.dimensions,{direction:a,distance:r,angle:s}=this.document;r*=e.size/e.distance,a=Math.toRadians(a);let o=this.document.distance*e.size/e.distance;r/=Math.cos(Math.toRadians(s/2));let l=[-(s/2),s/2].map(e=>Ray.fromAngle(0,0,a+Math.toRadians(e),r+1)),n=Math.sqrt((l[0].B.x-l[1].B.x)*(l[0].B.x-l[1].B.x)+(l[0].B.y-l[1].B.y)*(l[0].B.y-l[1].B.y));i.scale(o/this.texture.width,n/this.texture.height),i.translate(0,-n/2),i.rotate(t(this.document.direction))}e.beginTextureFill({texture:this.texture,matrix:i,alpha:1});let a=foundry.utils.getProperty(this.texture,"baseTexture.resource.source");a&&"VIDEO"===a.tagName&&(a.loop=!0,a.muted=!0,game.video.play(a))}else e.beginFill(0,0);return e.drawShape(this.shape),e.lineStyle(this._borderThickness,0).beginFill(0,.5).drawCircle(0,0,6).drawCircle(this.ray.dx,this.ray.dy,6).endFill(),this}}}if(game.settings.get("tokenmagic","autohideTemplateElements")){let t=function(e,...t){let i=this.texture,a=this._borderThickness;(this._original||this.parent===canvas.templates.preview)&&(this.texture=null),this.texture&&""!==this.texture&&!this._hover&&(this._borderThickness=0);let r=e(...t);this.texture=i,this._borderThickness=a;{let e=this._original??this,t=!this._original&&(this._hover||this.parent===canvas.templates.preview);if(!t&&e.template?.geometry){for(let t of e.template.geometry.graphicsData)t.shape!==e.shape&&(t.fillStyle.visible=!1,t.lineStyle.visible=!1);e.template.geometry.invalidate()}e.ruler&&(e.ruler.renderable=t),e.controlIcon&&(e.controlIcon.renderable=e.isOwner),e.handle&&(e.handle.renderable=e.isOwner)}return r};if(e){let i=e;e=function(){return t.call(this,i.bind(this),...arguments)}}else i="WRAPPER",e=t}game.settings.get("tokenmagic","defaultTemplateOnHover")&&Hooks.on("canvasReady",()=>{canvas.stage.on("mousemove",e=>{let{x:t,y:i}=e.data.getLocalPosition(canvas.templates);for(let e of canvas.templates.placeables){let a=canvas.interface.grid.getHighlightLayer(e.highlightId),r=e.document.getFlag("tokenmagic","templateData")?.opacity??1;if(e.texture&&""!==e.texture){let{x:s,y:o}=e.center,l=e.shape?.contains(t-s,i-o);a.renderable=l,e.template.alpha=(l?.5:1)*r}else a.renderable=!0,e.template.alpha=r}})}),libWrapper.register("tokenmagic","MeasuredTemplateDocument.prototype.update",r,"WRAPPER"),libWrapper.register("tokenmagic","foundry.canvas.placeables.MeasuredTemplate.prototype._draw",s,"WRAPPER"),libWrapper.register("tokenmagic","foundry.canvas.placeables.MeasuredTemplate.prototype._refreshState",function(e,...t){let i=e(...t);return this.template.alpha=this.document.getFlag("tokenmagic","templateData")?.opacity??1,this.controlIcon.visible=!!this.layer.active,this.controlIcon.border.visible=!!this.hover,i},"WRAPPER"),e&&libWrapper.register("tokenmagic","foundry.canvas.placeables.MeasuredTemplate.prototype._applyRenderFlags",e,i),a&&libWrapper.register("tokenmagic","foundry.canvas.placeables.MeasuredTemplate.prototype._refreshTemplate",a,"OVERRIDE")});let{HandlebarsApplicationMixin:eQ,ApplicationV2:eJ}=foundry.applications.api;function e0(){let e=foundry.applications.instances.get(e1.DEFAULT_OPTIONS.id);if(e){e.close();return}new e1().render(!0)}class e1 extends eQ(eJ){static DEFAULT_OPTIONS={id:"tmfx-toggler",window:{title:"TMFX Presets"},classes:["tokenmagic","toggler","flexcol"],actions:{toggle:e1._onTogglePreset,clear:e1._onClearAllPresets,toggleActiveOnly:e1._onToggleActiveOnly,clickControl:e1._onExecuteControlMacro,toggleTemplates:e1._onToggleTemplateDisplay}};static PARTS={header:{template:"modules/tokenmagic/templates/apps/preset-toggle-header.hbs"},presets:{template:"modules/tokenmagic/templates/apps/preset-toggle.hbs",scrollable:[".presets"]}};async _preparePartContext(e,t,i){switch(t.partId=e,e){case"presets":await this._preparePresetContext(t,i);break;case"header":await this._prepareHeaderContext(t,i)}return t}async _prepareHeaderContext(e,t){e.activeOnly=this._activeOnly,e.templates=this._templates,e.searchQuery=this._searchQuery??"";let i=[];Hooks.call("TokenMagic.getPresetTogglerControls",i),e.controls=i}async _preparePresetContext(e,t){let i=TokenMagic.getControlledPlaceables(),a=TokenMagic.getPresets(this._templates?eP.TEMPLATE:eP.MAIN);if(this._searchQuery?.trim()){let e=this._searchQuery.split(" ").map(e=>e.trim()).filter(Boolean);e.length&&(a=a.filter(t=>{let i=t.name.toLocaleLowerCase();return e.every(e=>i.includes(e))}))}a=a.map(e=>({name:e.name,id:e.params[0].filterId,active:i.some(t=>TokenMagic.hasFilterId(t,e.params[0].filterId)),texture:e.defaultTexture})),this._activeOnly&&(a=a.filter(e=>e.active)),e.presets=a}_attachPartListeners(e,t,i){super._attachPartListeners(e,t,i),"header"===e&&t.querySelector('input[type="search"]').addEventListener("input",this._onSearch.bind(this))}_onSearch(e){clearTimeout(this._searchTimeout),this._searchTimeout=setTimeout(()=>{this._searchQuery=e.target.value,this.render({parts:["presets"]})},200)}static async _onTogglePreset(e,t){let i=t.dataset.id,a=TokenMagic.getControlledPlaceables();if(!a.length)return;let r=a.some(e=>TokenMagic.hasFilterId(e,i)),s={name:t.dataset.name,library:this._templates?eP.TEMPLATE:eP.MAIN},o=t.dataset.texture;if(r){let e=new Set(TokenMagic.getPreset(s).map(e=>e.filterId));for(let t of a)for(let i of e)TokenMagic.hasFilterId(t,i)&&(await TokenMagic.deleteFilters(t,i),"MeasuredTemplate"!==t.document.documentName||t.document.flags.tokenmagic?.filters||await t.document.update({"-=texture":null}))}else{let e=TokenMagic.getPreset(s);for(let t of a)TokenMagic.hasFilterId(t,i)||(o&&"MeasuredTemplate"===t.document.documentName&&await t.document.update({texture:o}),await TokenMagic.addUpdateFilters(t,e))}this.render({parts:["presets"]})}static async _onClearAllPresets(e,t){await TokenMagic.deleteFiltersOnSelected(),this.render({parts:["presets"]})}static _onToggleActiveOnly(e,t){this._activeOnly=!this._activeOnly,this.render(!0)}static _onToggleTemplateDisplay(e,t){this._templates=!this._templates,this.render(!0)}static _onExecuteControlMacro(e,t){fromUuid(t.dataset.uuid).then(e=>e?.execute?.())}async _onFirstRender(e,t){for(let i of(await super._onFirstRender(e,t),this._hooks=[],["Token","Tile","MeasuredTemplate","Drawing","Region"])){let e=`control${i}`,t=Hooks.on(e,()=>{clearTimeout(this._controlHookTimeout),this._controlHookTimeout=setTimeout(()=>this.render({parts:["presets"]}),200)});this._hooks.push({hook:e,id:t})}}async close(e={}){await super.close(e),this._hooks?.forEach(e=>{Hooks.off(e.hook,e.id)})}}let e2="module.tokenmagic",e3={adjustment:a,ascii:r,dot:o,distortion:l,crt:eY,oldfilm:n,glow:c,outline:m,bevel:u,xbloom:s,shadow:class extends g{constructor(t){super(),this.enabled=!1,this.rotation=45,this.distance=5,this.color=0,this.alpha=.5,this.shadowOnly=!1,this.blur=2,this.quality=3,this.padding=10,this.zOrder=110,this.animated={},this.resolution=game.settings.get("core","pixelRatioResolutionScaling")?window.devicePixelRatio:PIXI.settings.FILTER_RESOLUTION,this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams()),this.autoFit=!1}},twist:v,zoomblur:b,blur:class extends y{constructor(t){super(),this.enabled=!1,this.blur=2,this.quality=4,this.zOrder=290,this.repeatEdgePixels=!1,this.animated={},this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams())}get blur(){return this.strengthX}set blur(e){this.strengthX=this.strengthY=e}get blurX(){return this.strengthX}set blurX(e){this.strengthX=e}get blurY(){return this.strengthY}set blurY(e){this.strengthY=e}calculatePadding(){let e=this.targetPlaceable.worldTransform.a;this.blurXFilter.blur=e*this.strengthX,this.blurYFilter.blur=e*this.strengthY,this.updatePadding(),super.calculatePadding()}},bulgepinch:P,zapshadow:M,ray:k,fog:_,xfog:O,electric:z,wave:E,shockwave:w,fire:Y,fumes:j,smoke:B,flood:q,images:H,field:U,xray:K,liquid:J,xglow:et,pixel:ei,web:er,ripples:eo,globes:en,transform:em,splash:ed,polymorph:eh,xfire:ev,sprite:ey,spriteMask:eT,replaceColor:eC,ddTint:class extends p{constructor(t){super(h,ew),this.tint=[1,0,0],this.zOrder=100,this.animating={},this.setTMParams(t),this.dummy||(this.anime=new e(this),this.normalizeTMParams())}get tint(){return this.uniforms.tint}set tint(e){this.uniforms.tint=e}},rgbSplit:eL},e5={TOKEN:foundry.canvas.placeables.Token.embeddedName,TILE:foundry.canvas.placeables.Tile.embeddedName,TEMPLATE:foundry.canvas.placeables.MeasuredTemplate.embeddedName,DRAWING:foundry.canvas.placeables.Drawing.embeddedName,REGION:foundry.canvas.placeables.Region.embeddedName,NOT_SUPPORTED:null};function e4(e){return game.i18n.localize(e)}async function e7(e,t){let i=JSON.stringify(e,null,4),a=document.createElement("a"),r=new Blob([i],{type:"plain/text"});a.href=URL.createObjectURL(r),a.download=t+".json",a.click(),URL.revokeObjectURL(a.href)}let e8={SET_FLAG:"TMFXSetFlag",SET_ANIME_FLAG:"TMFXSetAnimeFlag"};function e6(e,t,i){let a={tmAction:i,tmPlaceableId:e.id,tmPlaceableType:e._TMFXgetPlaceableType(),tmFlag:t,tmViewedScene:game.user.viewedScene};game.socket.emit(e2,a,e=>{})}function e9(e){return game.modules.has(e)&&!0===game.modules.get(e).active}function te(){return game.settings.get("tokenmagic","minPadding")}function tt(){return game.settings.get("tokenmagic","useAdditivePadding")}function ti(){return game.settings.get("tokenmagic","disableCaching")}function ta(){return game.settings.get("tokenmagic","disableVideo")}function tr(){let e=game.users.find(e=>e.isGM&&e.active);return e&&game.user===e}function ts(){return game.settings.get("tokenmagic","fxPlayerPermission")&&!tr()}function to(){canvas.app.renderer.filter.useMaxPadding=!tt()}function tl(){return game.settings.get("tokenmagic","useZOrder")}function tn(){return game.settings.get("tokenmagic","disableAnimations")}function tc(e){console.log("%cTokenMagic %c| "+e,"color:#4BC470","color:#B3B3B3")}function tm(e){console.warn("TokenMagic | "+e)}function tu(e){console.error("TokenMagic | "+e)}function td(e){if(e){let t="/modules/tokenmagic",i=new URL(e,window.location.href);if(i.origin===window.location.origin){let a="/";try{ROUTE_PREFIX&&(a=new URL(ROUTE_PREFIX,window.location.origin).pathname)}catch(e){}e=i.pathname,"/"===a?e=e.slice(1):e.startsWith(a)&&(e.length===a.length||"/"===e[a.length])?e=e.slice(a.length+1):e.startsWith(t)&&(e.length===t.length||"/"===e[t.length])&&(e=e.slice(1))}else e=i.href}return e}function tp(){return[canvas.tokens,canvas.tiles,canvas.drawings,canvas.regions,canvas.templates].some(e=>e===canvas.activeLayer)&&canvas.activeLayer.placeables.filter(e=>!0===e.controlled)||[]}function tf(){return canvas.tokens.placeables.filter(e=>e.isTargeted)}function th(e,t){let i=null;function a(e,t){let i=null;return null!=e&&e.length>0&&(i=e.find(e=>e.id===t)),i}switch(t){case e5.TOKEN:i=a(canvas.tokens.placeables,e);break;case e5.TILE:i=a(canvas.tiles.placeables,e);break;case e5.TEMPLATE:i=a(canvas.templates.placeables,e);break;case e5.DRAWING:i=a(canvas.drawings.placeables,e);break;case e5.REGION:i=a(canvas.regions.placeables,e)}return i}function tg(e){if(!e.randomized.hasOwnProperty("active")||e.randomized.active)for(let[t,i]of Object.entries(e.randomized)){let a;if(Array.isArray(i)||i.hasOwnProperty("list")){let e=i.list??i;a=e[Math.floor(Math.random()*e.length)]}else{let e=Math.min(i.val1,i.val2),t=Math.max(i.val1,i.val2),r=i.step??1;a=Math.floor((t-e+(Number.isInteger(r)?1:0))/r*Math.random())*r+e}setProperty(e,t,a),i.hasOwnProperty("link")&&setProperty(e,i.link,a)}}function tv(e,...t){return t.forEach(t=>{Object.keys(t).forEach(i=>{let a=t[i],r=e[i];a instanceof Array?e[i]=[...a]:e[i]=r&&a&&"object"==typeof r&&"object"==typeof a?tv(r,a):a})}),e}function tb(){let t=new PIXI.Container;async function i(e,t=!1){Array.isArray(e)||(e=T(e));let i=tp();if(null!=i&&i.length>0)for(let a of i)await o(a,e,t)}async function a(e){Array.isArray(e)||(e=T(e));let t=tp();if(null!=t&&t.length>0)for(let i of t)await l(i,e)}async function r(e){Array.isArray(e)||(e=T(e));let t=tf();if(null!=t&&t.length>0)for(let i of t)await l(i,e)}async function s(e,t=!1){Array.isArray(e)||(e=T(e));let i=tf();if(null!=i&&i.length>0)for(let a of i)await o(a,e,t)}async function o(e,t,i=!1){if(Array.isArray(t)||(t=T(t)),!(t instanceof Array&&t.length>0)||null==e)return;let a=i?null:e.document.getFlag("tokenmagic","filters"),r=[];for(let i of t){if(!i.hasOwnProperty("filterType")||!e3.hasOwnProperty(i.filterType))return;i.hasOwnProperty("rank")||(i.rank=e._TMFXgetMaxFilterRank()),i.hasOwnProperty("filterId")&&null!=i.filterId||(i.filterId=foundry.utils.randomID()),i.hasOwnProperty("enabled")&&"boolean"==typeof i.enabled||(i.enabled=!0),i.hasOwnProperty("randomized")&&i.randomized&&tg(i),i.placeableId=e.id,i.filterInternalId=foundry.utils.randomID(),i.filterOwner=game.data.userId,i.placeableType=e._TMFXgetPlaceableType(),i.updateId=foundry.utils.randomID(),r.push({tmFilters:{tmFilterId:i.filterId,tmFilterInternalId:i.filterInternalId,tmFilterType:i.filterType,tmFilterOwner:i.filterOwner,tmParams:i}})}null!=a&&(r=a.concat(r)),await e._TMFXsetFlag(r)}async function l(e,t){let i;if(!t instanceof Array||t.length<1)return;let a=e.document.getFlag("tokenmagic","filters"),r=[];a&&a.forEach(e=>{r.push(foundry.utils.duplicate(e))});let s=[];for(let a of t)if(i=!1,a.updateId=foundry.utils.randomID(),a.hasOwnProperty("randomized")&&a.randomized&&tg(a),r.forEach(e=>{e.tmFilters.tmFilterId===a.filterId&&e.tmFilters.tmFilterType===a.filterType&&e.tmFilters.hasOwnProperty("tmParams")&&(tv(e.tmFilters.tmParams,a),i=!0)}),!i){if(!a.hasOwnProperty("filterType")||!e3.hasOwnProperty(a.filterType))return;a.hasOwnProperty("rank")||(a.rank=e._TMFXgetMaxFilterRank()),a.hasOwnProperty("filterId")&&null!=a.filterId||(a.filterId=foundry.utils.randomID()),a.hasOwnProperty("enabled")&&"boolean"==typeof a.enabled||(a.enabled=!0),a.placeableId=e.id,a.filterInternalId=foundry.utils.randomID(),a.filterOwner=game.data.userId,a.placeableType=e._TMFXgetPlaceableType(),s.push({tmFilters:{tmFilterId:a.filterId,tmFilterInternalId:a.filterInternalId,tmFilterType:a.filterType,tmFilterOwner:a.filterOwner,tmParams:a}})}s.length>0&&(r=s.concat(r)),await e._TMFXsetFlag(r)}async function n(e,t){if(!(t instanceof Array)||t.length<1)return;let i=e.document.getFlag("tokenmagic","filters");if(null==i||!(i instanceof Array)||i.length<1)return;let a=[];for(let e of(i.forEach(e=>{a.push(foundry.utils.duplicate(e))}),t))e.updateId=foundry.utils.randomID(),e.hasOwnProperty("randomized")&&e.randomized&&tg(e),a.forEach(t=>{t.tmFilters.tmFilterId===e.filterId&&t.tmFilters.tmFilterType===e.filterType&&t.tmFilters.hasOwnProperty("tmParams")&&tv(t.tmFilters.tmParams,e)});await e._TMFXsetFlag(a)}async function c(e=null){let t=tf();if(null!=t&&t.length>0)for(let i of t)await u(i,e)}async function m(e=null){let t=tp();if(null!=t&&t.length>0)for(let i of t)await u(i,e)}async function u(e,t=null){if(null!=e){if(null==t)await e._TMFXunsetFlag(),await e._TMFXunsetAnimeFlag();else if("string"==typeof t){let i=e.document.getFlag("tokenmagic","filters");if(null==i||!(i instanceof Array)||i.length<1)return;let a=[];if(i.forEach(e=>{e.tmFilters.tmFilterId!==t&&a.push(foundry.utils.duplicate(e))}),a.length>0?await e._TMFXsetFlag(a):await e._TMFXunsetFlag(),null==(i=e.document.getFlag("tokenmagic","animeInfo"))||!(i instanceof Array)||i.length<1)return;a=[],i.forEach(e=>{e.tmFilterId!==t&&a.push(foundry.utils.duplicate(e))}),a.length>0?await e._TMFXsetAnimeFlag(a):await e._TMFXunsetAnimeFlag()}}}function d(e){let t=e=>e.includes(game.user.name)||e.includes(game.user.id);return!(e.users?.include?.length&&!t(e.users.include)||e.users?.exclude?.length&&t(e.users?.exclude))}function p(e,t,i){return null!=e&&null!=t&&e instanceof foundry.canvas.placeables.PlaceableObject?null!=i&&i instanceof Array&&!(i.length<1)&&void 0!==i.find(e=>e.tmFilters.tmFilterId===t):null}function f(e,t,i=!1){if(null==t||null==e)return;let a=e.document.getFlag("tokenmagic","animeInfo");for(let r of t)i&&function(e,t){if(e.hasOwnProperty("animated")&&t&&!(t.length<=0))for(let i of Object.keys(e.animated))for(let a of t.values())a.tmFilterId===e.filterId&&a.tmFilterInternalId===e.filterInternalId&&a.tmFilterEffect===i&&(e.animated[i].active=!1,e[i]=a.tmFilterEffectValue,"halfCosOscillation"===e.animated[i].animType&&e.animated[i].val1!==a.tmFilterEffectValue&&(e.animated[i].val2=e.animated[i].val1,e.animated[i].val1=a.tmFilterEffectValue))}(r.tmFilters.tmParams,a),h(e,r)}function h(e,t){if(null==t||!d(t.tmFilters.tmParams))return;let i=foundry.utils.duplicate(t);i.tmFilters.tmParams.placeableId=e.id,i.tmFilters.tmParams.placeableType=e._TMFXgetPlaceableType(),function(e,t){e._TMFXsetRawFilters(t)}(e,new e3[i.tmFilters.tmFilterType](i.tmFilters.tmParams))}function g(e,t=!1){let i=e._TMFXgetPlaceableType();if(i===e5.TEMPLATE){let t=e.document.getFlag("tokenmagic","templateData");null!=t&&(e.document.tmfxTextureAlpha=e._TMFXgetSprite().alpha=t.opacity,e.document.tmfxTint=t.tint)}else if(i===e5.REGION){let t=e._TMFXgetSprite();t&&(t.alpha=e.document.getFlag("tokenmagic","regionData")?.alpha??.5)}let a=e.document.getFlag("tokenmagic","filters");if(null!=a){if(i===e5.TEMPLATE)e.document.tmfxPreset=a[0].tmFilters.tmFilterId;else if(i===e5.REGION){let t=e._TMFXgetSprite();t&&t.setShaderClass(foundry.canvas.rendering.shaders.RegionShader)}f(e,a,t)}e.loadingRequest=!1}async function v(e,t={}){if(t.hasOwnProperty("overwrite")||(t.overwrite=game.settings.get("tokenmagic","importOverwrite")),tc("import -> checking import file format..."),!(e instanceof Array)||e.length<1)return tu("import -> file format check KO !"),tu(e4("TMFX.preset.import.format.failure")),!1;tc("import -> file format check OK !");let i=!0;for(let t of(tc("import -> checking import file content..."),e))if(t.hasOwnProperty("name")&&"string"==typeof t.name&&t.hasOwnProperty("params")&&t.params instanceof Array){for(let e of t.params)if(!(e.hasOwnProperty("filterType")&&e3.hasOwnProperty(e.filterType))){i=!1;break}if(!i)break}else{i=!1;break}if(!i)return tu("import -> file content check KO !"),tu(e4("TMFX.preset.import.format.failure")),!1;if(tc("import -> file content check OK !"),t.hasOwnProperty("replaceLibrary")&&t.replaceLibrary)return await game.settings.set("tokenmagic","presets",e),tc("import -> preset library replaced"),tc(e4("TMFX.preset.import.success")),!0;let a=game.settings.get("tokenmagic","presets"),r=0;for(let i of e){let e=a.find(e=>e.name===i.name);if(null==e)tc("import -> add: "+i.name),a.push(i),r++;else if(t.hasOwnProperty("overwrite")&&t.overwrite){let t=a.indexOf(e);t>-1&&(tc("import -> overwrite: "+i.name),a[t]=i,r++)}else tm("import -> ignored: "+i.name+" -> already exists")}return await game.settings.set("tokenmagic","presets",a),tc("import -> "+r+" preset(s) added to the library"),tc(e4("TMFX.preset.import.success")),!0}async function b(e,t={}){return(tc("import -> checking import file format..."),e instanceof Object)?(tc("import -> file format check OK !"),await game.settings.set("tokenmagic","autoTemplateSettings",e),tc("import -> automatic template settings replaced"),tc(e4("TMFX.preset.import.success")),!0):(tu("import -> file format check KO !"),tu(e4("TMFX.preset.import.format.failure")),!1)}async function y(e,t={}){try{let i=await fetch(e),a=await i.json();return await v(a,t)}catch(e){return tu(e.message),tu(e4("TMFX.preset.import.failure")),!1}}async function x(e,t={}){try{let i=await fetch(e),a=await i.json();return await b(a,t)}catch(e){return tu(e.message),tu(e4("TMFX.preset.import.failure")),!1}}function T(e){let t=null,i=null,a=e instanceof Object,{name:r,library:s,...o}=a?e:{};if(a?(e.hasOwnProperty("name")&&(t=e.name),e.hasOwnProperty("library")&&(i=e.library)):t=e,(null==i||"string"!=typeof i)&&(i=eP.MAIN),"string"!=typeof t)return;let l=game.settings.get("tokenmagic","presets");if(null==l||"object"!=typeof l)return;let n=l.find(e=>e.name===t&&e.library===i);if(null!=n&&n.hasOwnProperty("params")&&n.params instanceof Array){for(let[e,t]of Object.entries(o))for(let i of n.params)i.hasOwnProperty(e)&&(i[e]=t);return foundry.utils.deepClone(n.params)}}return{addFilters:o,addFiltersOnSelected:i,addFiltersOnTargeted:s,addUpdateFilters:l,addUpdateFiltersOnSelected:a,addUpdateFiltersOnTargeted:r,deleteFilters:u,deleteFiltersOnSelected:m,deleteFiltersOnTargeted:c,updateFilters:async function(t){if(null==params||!params.hasOwnProperty("filterId"))return;let i=new Set,a=e.getAnimeMap();if(!(a.size<=0)&&(a.forEach((e,a)=>{t.some(t=>t.filterId===e.puppet.filterId)&&i.add(e.puppet.placeableId)}),!(i.size<=0)))for(let e of i){let i=th(e,e5.TOKEN);null==i&&(i=th(e,e5.TEMPLATE)),null==i&&(i=th(e,e5.TILE)),null==i&&(i=th(e,e5.DRAWING)),null==i&&(i=th(e,e5.REGION)),null!=i&&i instanceof foundry.canvas.placeables.PlaceableObject&&await n(i,t)}},updateFiltersOnSelected:async function(e){let t=tp();if(null!=t&&!(t.length<1)&&("string"==typeof e&&(e=T(e)),e instanceof Array&&!(e.length<1)))for(let i of t)await n(i,e)},updateFiltersOnTargeted:async function(e){let t=tf();if(null!=t&&!(t.length<1)&&("string"==typeof e&&(e=T(e)),e instanceof Array&&!(e.length<1)))for(let i of t)await n(i,e)},updateFiltersByPlaceable:n,hasFilterType:function(e,t){if(null==e||null==t||!(e instanceof foundry.canvas.placeables.PlaceableObject))return null;let i=e.document.getFlag("tokenmagic","filters");return null!=i&&i instanceof Array&&!(i.length<1)&&void 0!==i.find(e=>e.tmFilters.tmFilterType===t)},hasFilterId:function(e,t){if(null==e||!(e instanceof foundry.canvas.placeables.PlaceableObject))return null;let i=e.document.getFlag("tokenmagic","filters");return p(e,t,i)},importTemplateSettings:async function(){new FilePicker({type:"json",current:"modules/tokenmagic/import",callback:x}).browse()},importTemplateSettingsFromPath:x,exportTemplateSettings:function(e="tmfx-template-settings"){let t=game.settings.get("tokenmagic","autoTemplateSettings");if(null==t||"object"!=typeof t)return!1;e7(t,e)},exportPresetLibrary:function(e="tmfx-presets"){let t=game.settings.get("tokenmagic","presets");if(null==t||"object"!=typeof t)return!1;e7(t,e)},importPresetLibrary:async function(){new FilePicker({type:"json",current:"modules/tokenmagic/import",callback:y}).browse()},importPresetLibraryFromURL:async function(e,t={}){try{$.getJSON(e,async function(e){return await v(e,t)})}catch(e){return tu(e.message),tu(e4("TMFX.preset.import.failure")),!1}},importPresetLibraryFromPath:y,resetPresetLibrary:async function(){if(game.user.isGM&&confirm(e4("TMFX.preset.reset.message")))try{await game.settings.set("tokenmagic","presets",eS),ui.notifications.info(e4("TMFX.preset.reset.success"))}catch(e){tu(e.message)}},getPresets:function(e=eP.MAIN){let t=game.settings.get("tokenmagic","presets");return null==t||"object"!=typeof t?[]:t.filter(t=>t.library===e)},getPreset:T,addPreset:async function(e,t,i=!1){if(!game.user.isGM)return i||ui.notifications.warn(e4("TMFX.preset.add.permission.failure")),!1;let a=null,r=null,s=null;if(e instanceof Object?(e.hasOwnProperty("name")&&(a=e.name),e.hasOwnProperty("library")&&(r=e.library),e.hasOwnProperty("defaultTexture")&&(s=td(e.defaultTexture))):a=e,(null==r||"string"!=typeof r)&&(r=eP.MAIN),"string"!=typeof s&&(s=null),"string"!=typeof a&&!(t instanceof Array))return i||ui.notifications.error(e4("TMFX.preset.add.params.failure")),!1;for(let e of t)e.filterId=a;let o=game.settings.get("tokenmagic","presets"),l={};l.name=a,l.library=r,l.params=t,null!=s&&(l.defaultTexture=s);let n=!0;if(null==o?o=[l]:null==o.find(e=>e.name===a&&e.library===r)?o.push(l):(i||ui.notifications.warn(e4("TMFX.preset.add.duplicate.failure")),n=!1),n)try{await game.settings.set("tokenmagic","presets",o),i||ui.notifications.info(e4("TMFX.preset.add.success"))}catch(e){i||ui.notifications.error(e.message),console.error(e),n=!1}return n},deletePreset:async function(e,t=!1){if(!game.user.isGM)return t||ui.notifications.warn(e4("TMFX.preset.delete.permission.failure")),!1;let i=null,a=null;if(e instanceof Object?(e.hasOwnProperty("name")&&(i=e.name),e.hasOwnProperty("library")&&(a=e.library)):i=e,(null==a||"string"!=typeof a)&&(a=eP.MAIN),"string"!=typeof i)return t||ui.notifications.error(e4("TMFX.preset.delete.params.failure")),!1;let r=game.settings.get("tokenmagic","presets");if(null==r)return t||ui.notifications.warn(e4("TMFX.preset.delete.empty.failure")),!1;let s=!0,o=r.find(e=>e.name===i&&e.library===a);if(null==o)t||ui.notifications.warn(e4("TMFX.preset.delete.notfound.failure")),s=!1;else{let e=r.indexOf(o);if(e>-1){r.splice(e,1);try{await game.settings.set("tokenmagic","presets",r),t||ui.notifications.info(e4("TMFX.preset.delete.success"))}catch(e){t||ui.notifications.error(e.message),console.error(e),s=!1}}}return s},getControlledPlaceables:tp,getTargetedTokens:tf,getPlaceableById:th,activatePresetToggler:e0,get filterTypes(){return e3},_assignFilters:f,_loadFilters:function(e,t=!0){null!=e&&e.slice().reverse().forEach(e=>{g(e,t)})},_clearImgFiltersByPlaceable:function(e,t=null){if(null==e)return;let i=null!=t&&"string"==typeof t,a=e._TMFXgetSprite();null!=a&&(!function(e){if(e instanceof Array)for(let a of e.filter(e=>i?e.hasOwnProperty("filterId")&&e.filterId===t:e.hasOwnProperty("filterId")))a.enabled=!1,a.destroy()}(a.filters),a.filters=function(e){if(e instanceof Array){let a=e.filter(e=>i?!(e.hasOwnProperty("filterId")&&e.filterId===t):!e.hasOwnProperty("filterId"));return 0===a.length?null:a}return e}(a.filters))},_getAnimeMap:e.getAnimeMap,_updateFilters:function(t,i,a){if(!(i.hasOwnProperty("flags")&&i.flags.hasOwnProperty("tokenmagic")&&(i.flags.tokenmagic.hasOwnProperty("filters")||i.flags.tokenmagic.hasOwnProperty("-=filters")))||null==t||!t.hasOwnProperty("_id"))return;let r=th(t._id,a);if(null==r)return;if(i.flags.tokenmagic.hasOwnProperty("-=filters")){e.removeAnimation(t._id),this._clearImgFiltersByPlaceable(r);return}let s=r.document.getFlag("tokenmagic","filters");if(null!=s){for(let i of e.getAnimeMap().values())if(i.puppet.placeableId===r.id){let a=!1;s.forEach(e=>{i.puppet.filterId===e.tmFilters.tmFilterId&&i.puppet.filterInternalId===e.tmFilters.tmFilterInternalId&&i.puppet.placeableId===e.tmFilters.tmParams.placeableId&&d(e.tmFilters.tmParams)&&(a=!0)}),a||(e.removeAnimationByFilterId(t._id,i.puppet.filterId),this._clearImgFiltersByPlaceable(r,i.puppet.filterId))}s.forEach(t=>{if(t.tmFilters.hasOwnProperty("tmParams")){let i=e.getPuppetsByParams(t.tmFilters.tmParams);if(i.length>0)for(let e of i)!function e(t,i){function a(e){return null!=e&&"object"==typeof e}for(let r of Object.keys(t)){let s=t[r],o=i[r],l=a(s)&&a(o);if(l&&!e(s,o)||(l||"loops"!==r||null!==s||(s=1/0),!l&&s!==o))return!1}return!0}(t.tmFilters.tmParams,e)&&(!e.hasOwnProperty("updateId")||e.hasOwnProperty("updateId")&&e.updateId!==t.tmFilters.tmParams.updateId)&&(e.setTMParams(foundry.utils.duplicate(t.tmFilters.tmParams)),e.normalizeTMParams());else h(r,t)}})}},_updateTemplateData:function(e,t,i){if(!t.hasOwnProperty("flags")||!t.flags.hasOwnProperty("tokenmagic")||null==e||!e.hasOwnProperty("_id"))return;let a=th(e._id,i);if(null==a)return;let r=a.document.getFlag("tokenmagic","templateData");null!=r&&(a._TMFXgetSprite().alpha=r.opacity)},_singleLoadFilters:g,_cachedContainer:t,_checkFilterId:p,_getPresetTemplateDefaultTexture:function(e,t=eP.TEMPLATE){let i=game.settings.get("tokenmagic","presets").find(i=>i.name===e&&i.library===t);return null!=i&&i.hasOwnProperty("defaultTexture")?td(i.defaultTexture):null}}}let ty=tb();async function tx(){let e={enabled:!0,dummy:!0};for(let t of(ty._cachedContainer.filters=[],Object.keys(e3)))e.filterType=t,tc(`Caching ${t}`),ty._cachedContainer.filters.push(new e3[t](e));tc("Compiling shaders...");let t=new PIXI.RenderTexture.create({width:4,height:4});canvas.app.renderer.render(ty._cachedContainer,{renderTexture:t}),tc("Shaders compiled for the GPU and ready!")}async function tT(e,t=0){let i;e.loadingRequest=!0,setTimeout(()=>{setTimeout(()=>{clearTimeout(i)},2e3),function e(t){i=setTimeout(()=>{if(null==t)return;let i=t._TMFXcheckSprite();if(null==i){t.loadingRequest=!1;return}i?ty._singleLoadFilters(t):e(t)},35)}(e)},t)}function tC(e,t,i){if("circle"===i||"rect"===i)return{x:.5,y:.5};let a=e*Math.PI/180,r=t*Math.PI/180,s=Math.cos(a-r/2),o=-Math.sin(a-r/2),l=Math.cos(a+r/2),n=-Math.sin(a+r/2),c=0,m=1;return s<0&&l<0?c=1:(s<0||l<0)&&(c=(Math.sin(-a-Math.PI/2)+1)/2),o<0&&n<0?m=0:(o<0||n<0)&&(m=(Math.cos(-a-Math.PI/2)+1)/2),{x:c,y:m}}function tw(e,i){i=$(i),ta()||i.find('[name="texture"]').attr("type","imagevideo");let a=e.document.object,r=a.template.alpha,s="",o=t,l=a.document.getFlag("tokenmagic","templateData");null!=l&&l instanceof Object&&(r=a.document.tmfxTextureAlpha=l.opacity,s=a.document.tmfxTint=l.tint?PIXI.utils.hex2string(l.tint):"",void 0!==l.preset&&(o=l.preset));let n=a.document.getFlag("tokenmagic","filters"),c=ty.getPresets(eP.TEMPLATE);n&&n instanceof Array&&n.length>=1&&(o=n[0].tmFilters.tmFilterId);let m="",u="";m+=`<option value="${t}"></option>`,c.sort(function(e,t){return e.name<t.name?-1:e.name>t.name?1:0}).forEach(e=>{u=e.name===o?" selected":"",m+=`<option value="${e.name}"${u}>${e.name}</option>`});let d=`
    <div class="form-group">
        <label>${e4("TMFX.template.opacity")}</label>
    ...
    <div class="form-group">
        <label>${e4("TMFX.template.fx")}</label>
    ...
    <div class="form-group">
        <label>${e4("TMFX.template.tint")}</label>
        <div class="form-fields">
    ...
    `;i.find('[name="hidden"]').closest(".form-group").after(d),e.setPosition({height:"auto"})}async function tP(e,t){if(t.querySelector('[name="flags.tokenmagic.regionData.alpha"]'))return;let i=e.document,a=i.getFlag("tokenmagic","regionData"),r=a?.alpha??i.object?._TMFXgetSprite()?.alpha??.5,s=await foundry.applications.handlebars.renderTemplate("modules/tokenmagic/templates/settings/regionAlpha.hbs",{alpha:r});$(t).find('[name="color"]').closest(".form-group").after(s)}Hooks.on("ready",()=>{tc("Hook -> ready"),eO(),function(){let e=game.users.find(e=>e.isGM&&e.active);e&&game.user!==e||game.socket.on(e2,async e=>{if(null!=e&&e.hasOwnProperty("tmAction"))switch(e.tmAction){case e8.SET_FLAG:await t("filters");break;case e8.SET_ANIME_FLAG:await t("animeInfo")}async function t(t){let i,a=game.scenes.get(e.tmViewedScene);null!=a&&((i=null==e.tmFlag?{[`flags.tokenmagic.-=${t}`]:null}:{[`flags.tokenmagic.${t}`]:e.tmFlag})._id=e.tmPlaceableId,await a.updateEmbeddedDocuments(e.tmPlaceableType,[i]))}})}(),window.TokenMagic=ty,!game.modules.get("lib-wrapper")?.active&&game.user.isGM&&ui.notifications.warn("The 'Token Magic FX' module recommends to install and activate the 'libWrapper' module."),Hooks.on("renderMeasuredTemplateConfig",tw),Hooks.on("renderRegionConfig",tP)}),Hooks.once("canvasInit",e=>{ti()||(tc("Init -> canvasInit -> caching shaders"),tx())}),Hooks.on("canvasInit",t=>{tc("Hook -> canvasInit"),to(),e.deactivateAnimation(),e.resetAnimation()}),Hooks.on("canvasReady",t=>{if(tc("Hook -> canvasReady"),window.hasOwnProperty("TokenMagic")||(window.TokenMagic=ty),null==t)return;let i=t.tokens.placeables;ty._loadFilters(i);let a=t.tiles.placeables;ty._loadFilters(a);let r=t.drawings.placeables;ty._loadFilters(r);let s=t.templates.placeables;ty._loadFilters(s);let o=t.regions.placeables;ty._loadFilters(o),e.activateAnimation()}),Hooks.on("deleteScene",t=>{t.id===game.user.viewedScene&&(e.deactivateAnimation(),e.resetAnimation())}),Hooks.on("closeSettingsConfig",()=>{to()}),Hooks.on("createToken",e=>{e.parent.id===game.user.viewedScene&&e.flags?.tokenmagic?.filters&&tT(th(e._id,e5.TOKEN),250)}),Hooks.on("deleteToken",(t,i)=>{null!=i&&i._id&&e.removeAnimation(i._id)}),Hooks.on("updateToken",(t,i)=>{if(t.parent.id===game.user.viewedScene){if(["img","tint","height","width","name"].some(e=>e in i)){let i=th(t._id,e5.TOKEN);e.removeAnimation(t._id),ty._clearImgFiltersByPlaceable(i),tT(i,250)}else ty._updateFilters(t,i,e5.TOKEN)}}),Hooks.on("createTile",e=>{e.parent.id===game.user.viewedScene&&e.flags?.tokenmagic?.filters&&tT(th(e._id,e5.TILE),250)}),Hooks.on("deleteTile",(t,i)=>{null!=i&&i._id&&e.removeAnimation(i._id)}),Hooks.on("updateTile",(t,i)=>{if(t.parent.id===game.user.viewedScene){if(i.texture?.src||i.overhead){let i=th(t._id,e5.TILE);e.removeAnimation(t._id),ty._clearImgFiltersByPlaceable(i),tT(i,250)}else ty._updateFilters(t,i,e5.TILE)}}),Hooks.on("createDrawing",e=>{e.parent.id===game.user.viewedScene&&e.flags?.tokenmagic?.filters&&tT(th(e._id,e5.DRAWING),250)}),Hooks.on("deleteDrawing",(t,i)=>{null!=i&&i._id&&e.removeAnimation(i._id)}),Hooks.on("updateDrawing",(t,i)=>{if(t.parent.id===game.user.viewedScene){if(!i.flags?.tokenmagic||i.x||i.y){let i=th(t._id,e5.DRAWING);e.removeAnimation(t._id),ty._clearImgFiltersByPlaceable(i),tT(i,250)}else ty._updateFilters(t,i,e5.DRAWING)}}),Hooks.on("createRegion",e=>{e.parent.id===game.user.viewedScene&&e.flags?.tokenmagic?.filters&&tT(th(e._id,e5.REGION),250)}),Hooks.on("deleteRegion",(t,i)=>{null!=i&&i._id&&e.removeAnimation(i._id)}),Hooks.on("updateRegion",(t,i)=>{if(t.parent.id!==game.user.viewedScene)return;let a=th(t._id,e5.REGION);if(!i.flags?.tokenmagic||i.x||i.y)e.removeAnimation(t._id),ty._clearImgFiltersByPlaceable(a),tT(a,250);else if(!a.loadingRequest){ty._updateFilters(t,i,e5.REGION);let e=th(t._id,e5.REGION)?._TMFXgetSprite();e&&(t.getFlag("tokenmagic","filters")?e.setShaderClass(foundry.canvas.rendering.shaders.RegionShader):e.setShaderClass(foundry.canvas.rendering.shaders.HighlightRegionShader),e.alpha=t.getFlag("tokenmagic","regionData")?.alpha??.5)}}),Hooks.on("createMeasuredTemplate",e=>{let t=e.parent;null!=t&&t.id===game.user.viewedScene&&e.flags?.tokenmagic?.filters&&tT(th(e._id,e5.TEMPLATE),250)}),Hooks.on("deleteMeasuredTemplate",(t,i)=>{null!=i&&i._id&&e.removeAnimation(i._id)}),Hooks.on("updateMeasuredTemplate",(t,i)=>{if(t.parent.id!==game.user.viewedScene)return;let a=th(t._id,e5.TEMPLATE);a&&(i.texture?(e.removeAnimation(t._id),ty._clearImgFiltersByPlaceable(a),tT(a,250)):(a.loadingRequest||(ty._updateFilters(t,i,e5.TEMPLATE),ty._updateTemplateData(t,i,e5.TEMPLATE)),"-=texture"in i&&t.object?.draw()))}),Hooks.on("preUpdateMeasuredTemplate",async(e,i)=>{let a=canvas.templates.get(e._id),r=i.flags?.tokenmagic?.templateData?.tint!==void 0?i.flags.tokenmagic.templateData.tint:e.flags?.tokenmagic?.tint!==void 0?e.flags.tokenmagic.tint:"",s=i.flags?.tokenmagic?.templateData?.preset!==void 0,o=i.flags?.tokenmagic?.templateData?.tint!==void 0,l=i.hasOwnProperty("direction"),n=i.hasOwnProperty("angle"),c=i.hasOwnProperty("t");if(o&&(i.flags.tokenmagic.templateData.tint=""!==r?Color.from(r).valueOf():null),s||o||l||c||n){let o=i.flags?.tokenmagic?.templateData?.preset!==void 0?i.flags.tokenmagic.templateData.preset:e.flags?.tokenmagic?.templateData?.preset!==void 0?e.flags.tokenmagic.templateData.preset:void 0!==e.tmfxPreset?e.tmfxPreset:t;if(o!==t){let t=tC(i.direction?i.direction:e.direction?e.direction:0,i.angle?i.angle:e.angle?e.angle:0,i.t?i.t:e.t?e.t:"ITSBAD"),l={name:o,library:eP.TEMPLATE,anchorX:t.x,anchorY:t.y};r&&""!==r&&(l.color=Color.from(r).valueOf());let n=ty.getPreset(l);null!=n&&(s?await a.TMFXaddFilters(n,!0):await a.TMFXaddUpdateFilters(n))}else await a.TMFXdeleteFilters()}i.flags?.tokenmagic?.hasOwnProperty("-=filters")&&(i["-=texture"]=null)}),Hooks.on("preCreateMeasuredTemplate",e=>{if(game.Levels3DPreview?._active)return;let i=eK.getSystemTemplates();i?.enabled&&i.preCreateMeasuredTemplate?.(e);let a=e.flags,r=!1,s=!1,o=!1,l=!1;if(a&&e.flags.tokenmagic?.options){let t=e.flags.tokenmagic.options;t.tmfxPreset&&(e.tmfxPreset=t.tmfxPreset,r=!0),t.tmfxTint&&(e.tmfxTint=t.tmfxTint,s=!0),t.tmfxTextureAlpha&&(e.tmfxTextureAlpha=t.tmfxTextureAlpha,o=!0),t.tmfxTexture&&(e.texture=t.tmfxTexture,e.updateSource({texture:t.tmfxTexture}))}else l=!0;let n=e.texture&&""!==e.texture,c=[];if(a&&l){if(e.flags.tokenmagic)return;e.flags=foundry.utils.mergeObject(e.flags,{tokenmagic:{filters:null,templateData:null,options:null}},!0,!0)}s&&"number"!=typeof e.tmfxTint&&(e.tmfxTint=Color.from(e.tmfxTint).valueOf());let m=null;if(r){let t=tC(e.direction,e.angle,e.t),i={name:e.tmfxPreset,library:eP.TEMPLATE,anchorX:t.x,anchorY:t.y};s&&(i.color=e.tmfxTint);let a=ty.getPreset(i);if(null!=a&&a instanceof Array){let t=ty._getPresetTemplateDefaultTexture(i.name);null==t||n||e.updateSource({texture:t});let r=!0;for(let e of a){if(!e.filterType||!e3.hasOwnProperty(e.filterType)||!e.filterId){r=!1;break}e.enabled&&"boolean"==typeof e.enabled||(e.enabled=!0),e.placeableId=null,e.filterInternalId=foundry.utils.randomID(),e.filterOwner=game.data.userId,e.placeableType=e5.TEMPLATE,c.push({tmFilters:{tmFilterId:e.filterId,tmFilterInternalId:e.filterInternalId,tmFilterType:e.filterType,tmFilterOwner:e.filterOwner,tmParams:e}})}r&&(m=c)}}else e.tmfxPreset=t;o||(e.tmfxTextureAlpha=1),s||(e.tmfxTint=null);let u={templateData:{opacity:e.tmfxTextureAlpha,tint:e.tmfxTint},filters:m,options:null};e.updateSource({flags:{tokenmagic:u}})});export{e3 as FilterType,e5 as PlaceableType,e8 as SocketAction,e6 as broadcast,e9 as isActiveModule,te as getMinPadding,tt as isAdditivePaddingConfig,ti as isFilterCachingDisabled,ta as isVideoDisabled,tr as isTheOne,ts as mustBroadCast,to as autosetPaddingMode,tl as isZOrderConfig,tn as isAnimationDisabled,tc as log,tm as warn,tu as error,td as fixPath,tp as getControlledPlaceables,tf as getTargetedTokens,th as getPlaceableById,tv as objectAssign,tb as TokenMagic,ty as Magic};
