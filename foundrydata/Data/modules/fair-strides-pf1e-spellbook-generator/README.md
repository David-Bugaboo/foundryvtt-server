...
In version 3.0.0, I've added a long-requested feature to be able to populate the spellbook's contents with the spells on an actor already, such as prepping all the spells in a Wizard PC's spells tab. This **_WILL_** override whatever the spellbook's contents were when this is done! This has been done with care to avoid duplicates when the names match. It will not root out metamagicked spells and may mistakenly add them to the wrong spell level, so some manual tweaking and adjustment of the spell lists is required before you finish making your spellbook.
...
Manifest URL: https://gitlab.com/Tryss_Farron/pf1-spellbook-generator/-/raw/main/module.json
