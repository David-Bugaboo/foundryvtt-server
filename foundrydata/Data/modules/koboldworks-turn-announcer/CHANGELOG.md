...
- Fix: Combatants with no actor were not handled.
- Foundry v12 and v13 support. Older no longer supported.

## 1.6.0

- Fix: Oddness with determining user who controls current combatant, usually resulting in claiming previous player controls an NPC.
- Fix: Token name visible option no longer hides the name for anyone with observer or higher permission on the actor.
- Change: Foundry v10 and older support removed.
